            ...
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('institution.salary.structures.index')); ?>">Salary Structures</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('institution.salary.structures.index')); ?>" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
...
$(document).ready(function() {
    ...
    $('#salaryStructureForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("institution.salary.structures.store")); ?>',
            type: 'POST',
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/salary/structures/create.blade.php ENDPATH**/ ?>