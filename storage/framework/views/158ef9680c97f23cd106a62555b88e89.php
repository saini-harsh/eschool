                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="<?php echo e(route('institution.nonworkingstaff.index')); ?>" class="link-danger text-decoration-underline">Clear
                                        All</a>
                                </div>
                            </div>
                        </div>
                        <form action="<?php echo e(route('institution.nonworkingstaff.index')); ?>" method="GET">
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="form-label">Name</label>
                                        <a href="<?php echo e(route('institution.nonworkingstaff.index')); ?>" class="link-primary mb-1">Reset</a>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-flex align-items-center">
                                    <a href="<?php echo e(route('institution.login-as.staff', $member->id)); ?>" 
                                        class="btn btn-icon btn-sm btn-secondary border-0" title="No Dashboard Available">
                                        <i class="ti ti-login"></i>
                                    </a>
                                    <a href="<?php echo e(route('institution.nonworkingstaff.permissions', $member->id)); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/nonworkingstaff/index.blade.php ENDPATH**/ ?>