    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div>
                ...
                <a href="<?php echo e(route('institution.admission.admission-form')); ?>" class="btn btn-outline-secondary"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="card class-card h-100" data-class-id="<?php echo e($class->id); ?>"
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="card-title mb-2">Class - <?php echo e($class->name); ?></h5>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            downloadTemplate.addEventListener('click', function(e) {
                ...
                window.location.href = '<?php echo e(route("institution.students.download-template")); ?>';
            });
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performSearch(query) {
                fetch(`<?php echo e(route('institution.students.search')); ?>?q=${encodeURIComponent(query)}`, {
                    headers: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadStudentsWithSiblings() {
                ...
                fetch('<?php echo e(route("institution.students.with-siblings")); ?>', {
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
                        'Accept': 'application/json'
                    }
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/students/index.blade.php ENDPATH**/ ?>