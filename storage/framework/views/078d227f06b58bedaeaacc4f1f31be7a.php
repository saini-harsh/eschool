                            ...
                            <tbody>
                                <?php $__currentLoopData = $admissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-info"><?php echo e($admission->schoolClass->name ?? 'N/A'); ?></span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small
                                                class="text-muted"><?php echo e($admission->created_at->format('h:i A')); ?></small>
                                        </td>
                                        <td>
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <iframe src="<?php echo e(route('institution.admission.preview-excel', request()->query())); ?>"
                        style="width: 100%; height: 100%; border: none;"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <a href="<?php echo e(route('institution.admission.export', request()->query())); ?>" class="btn btn-success">
