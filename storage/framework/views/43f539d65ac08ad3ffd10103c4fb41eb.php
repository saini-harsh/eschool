            ...
            <div class="tab-pane" id="nav_tab_3" role="tabpanel">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="fw-bold mb-0 text-primary">AADHAAR CARD DOCUMENTS</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="upload-area">
                                            <input type="file" name="aadhaar_front" id="aadhaar_front" class="d-none" accept="image/*" onchange="previewAadhaarFront(this)">
                                            <div class="upload-content" onclick="document.getElementById('aadhaar_front').click()">
                                                <div class="upload-icon">
                                                    <i class="ti ti-file-upload text-primary" style="font-size: 24px;"></i>
                                                </div>
                                                <div class="upload-text">
                                                    <span class="upload-title">Click to upload Aadhaar front</span>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="upload-area">
                                            <input type="file" name="aadhaar_back" id="aadhaar_back" class="d-none" accept="image/*" onchange="previewAadhaarBack(this)">
                                            <div class="upload-content" onclick="document.getElementById('aadhaar_back').click()">
                                                <div class="upload-icon">
                                                    <i class="ti ti-file-upload text-primary" style="font-size: 24px;"></i>
                                                </div>
                                                <div class="upload-text">
                                                    <span class="upload-title">Click to upload Aadhaar back</span>
                                                    <small class="upload-subtitle">JPG, PNG (Max 10MB)</small>
                                                </div>
                                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="fw-bold mb-0 text-primary">PAN CARD DOCUMENTS</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="upload-area">
                                            <input type="file" name="pan_front" id="pan_front" class="d-none" accept="image/*" onchange="previewPanFront(this)">
                                            <div class="upload-content" onclick="document.getElementById('pan_front').click()">
                                                <div class="upload-icon">
                                                    <i class="ti ti-file-upload text-primary" style="font-size: 24px;"></i>
                                                </div>
                                                <div class="upload-text">
                                                    <span class="upload-title">Click to upload PAN front</span>
                                                    <small class="upload-subtitle">JPG, PNG (Max 10MB)</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="upload-area">
                                            <input type="file" name="pan_back" id="pan_back" class="d-none" accept="image/*" onchange="previewPanBack(this)">
                                            <div class="upload-content" onclick="document.getElementById('pan_back').click()">
                                                <div class="upload-icon">
                                                    <i class="ti ti-file-upload text-primary" style="font-size: 24px;"></i>
                                                </div>
                                                <div class="upload-text">
                                                    <span class="upload-title">Click to upload PAN back</span>
                                                    <small class="upload-subtitle">JPG, PNG (Max 10MB)</small>
                                                </div>
                                            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(document).ready(function() {
                ...
                window.previewAadhaarFront = function(input) {
                    if (input.files && input.files[0]) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            document.getElementById('aadhaarFrontPreview').src = e.target.result;
                            document.getElementById('aadhaarFrontPreviewContainer').style.display = 'block';
                        }
                        reader.readAsDataURL(input.files[0]);
                    }
                }
                ...
                window.previewAadhaarBack = function(input) {
                    if (input.files && input.files[0]) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            document.getElementById('aadhaarBackPreview').src = e.target.result;
                            document.getElementById('aadhaarBackPreviewContainer').style.display = 'block';
                        }
                        reader.readAsDataURL(input.files[0]);
                    }
                }
                ...
                // PAN Front Preview
                window.previewPanFront = function(input) {
                    if (input.files && input.files[0]) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            document.getElementById('panFrontPreview').src = e.target.result;
                            document.getElementById('panFrontPreviewContainer').style.display = 'block';
                        }
                        reader.readAsDataURL(input.files[0]);
                    }
                }
                ...
                // PAN Back Preview
                window.previewPanBack = function(input) {
                    if (input.files && input.files[0]) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            document.getElementById('panBackPreview').src = e.target.result;
                            document.getElementById('panBackPreviewContainer').style.display = 'block';
                        }
                        reader.readAsDataURL(input.files[0]);
                    }
                }
                ...
                // Remove Functions
                window.removeAadhaarFront = function() {
                    document.getElementById('aadhaar_front').value = '';
                    document.getElementById('aadhaarFrontPreview').src = '';
                    document.getElementById('aadhaarFrontPreviewContainer').style.display = 'none';
                }

                window.removeAadhaarBack = function() {
                    document.getElementById('aadhaar_back').value = '';
                    document.getElementById('aadhaarBackPreview').src = '';
                    document.getElementById('aadhaarBackPreviewContainer').style.display = 'none';
                }

                window.removePanFront = function() {
                    document.getElementById('pan_front').value = '';
                    document.getElementById('panFrontPreview').src = '';
                    document.getElementById('panFrontPreviewContainer').style.display = 'none';
                }

                window.removePanBack = function() {
                    document.getElementById('pan_back').value = '';
                    document.getElementById('panBackPreview').src = '';
                    document.getElementById('panBackPreviewContainer').style.display = 'none';
                }
            });
        </script>
    <?php $__env->stopPush(); ?>
