                    ...
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.rooms*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('admin.rooms.index')); ?>">
                                        <i class="ti ti-home"></i><span>Class Rooms</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.invigilators*') ? 'active' : ''); ?>"
                                        href="#">
