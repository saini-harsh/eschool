...
<?php $__env->startSection('title', 'Teacher | Lesson Plans'); ?>
        ...
        <div class="flex-grow-1">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                    <li class="breadcrumb-item d-flex align-items-center"><a href="<?php echo e(route('teacher.dashboard')); ?>"><i
                            ...
                            <select name="subject_id" id="subject_id" class="form-select" required>
                                ...
                                <?php if(isset($subjects) && !empty($subjects)): ?>
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($subject->id); ?>" data-class-id="<?php echo e($subject->class_id); ?>"><?php echo e($subject->name); ?> (<?php echo e($subject->code); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="dropdown me-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0" id="filter-dropdown">
                            <div class="card mb-0">
                                ...
                                <form action="<?php echo e(route('teacher.lesson-plans.index')); ?>" method="GET" id="filter-form">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <tr data-lesson-plan-id="<?php echo e($lessonPlan->id); ?>">
                                    ...
                                    <td>
                                        <?php if($lessonPlan->lesson_plan_file): ?>
                                            ...
                                            <a href="<?php echo e(route('teacher.lesson-plans.download', $lessonPlan->id)); ?>" 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (clearAllLink) {
            clearAllLink.addEventListener('click', function() {
                window.location.href = '<?php echo e(route("teacher.lesson-plans.index")); ?>';
            });
        }
...
<script src="<?php echo e(asset('custom/js/teacher/lesson-plans.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/teacher/routines/lesson-plans/index.blade.php ENDPATH**/ ?>