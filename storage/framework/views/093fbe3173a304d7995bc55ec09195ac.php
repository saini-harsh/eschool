<?php $__env->startSection('title', 'Institution | Add Non-Working Staff'); ?>
...
<div class="content">
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div>
                <h6 class="mb-3 fs-14">
                    <a href="<?php echo e(route('institution.nonworkingstaff.index')); ?>">
                        <i class="ti ti-arrow-left me-1"></i>Non-Working Staff
                    </a>
                </h6>

                <form action="<?php echo e(route('institution.nonworkingstaff.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?> 
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" name="salary" class="form-control" placeholder="e.g., 15000">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-end mt-3">
                        <a href="<?php echo e(route('institution.nonworkingstaff.index')); ?>" class="btn btn-light me-2">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/nonworkingstaff/create.blade.php ENDPATH**/ ?>