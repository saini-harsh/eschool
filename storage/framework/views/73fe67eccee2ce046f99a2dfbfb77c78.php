                        ...
                        <form id="event-form" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="institution_id" required>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Institution::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="card-body">
                                                                    ...
                                                                    <li>
                                                                        <label
                                                                            ...
                                                                            <input class="form-check-input m-0 me-2" type="checkbox" 
                                                                                ...
                                                                                <?php echo e(in_array($institution->id, request('institution_ids', [])) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <a href="javascript:void(0);" class="link-primary mb-1 filter-reset" data-field="roles">Reset</a>
                                                    </div>
                                                    <div class="dropdown">
                                                        <a href="javascript:void(0);"
                                                            class="dropdown-toggle justify-content-between btn bg-light justify-content-start border w-100"
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu w-100">
                                                            <?php $roleSelections = (array) request('roles', []); ?>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="teacher" <?php echo e(in_array('teacher', $roleSelections) ? 'checked' : ''); ?>>
                                                                    Teacher
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="student" <?php echo e(in_array('student', $roleSelections) ? 'checked' : ''); ?>>
                                                                    Student
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="nonworkingstaff" <?php echo e(in_array('nonworkingstaff', $roleSelections) ? 'checked' : ''); ?>>
                                                                    Non-Working Staff
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="all" <?php echo e(in_array('all', $roleSelections) ? 'checked' : ''); ?>>
                                                                    All
                                                                </label>
                                                            </li>
                                                        </ul>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('custom/js/admin/events.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/academic/events/index.blade.php ENDPATH**/ ?>