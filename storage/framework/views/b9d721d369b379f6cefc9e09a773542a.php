                                        ...
                                        <div class="text-center mb-3">
                                            <?php if($teacher->profile_image): ?>
                                                <span class="avatar avatar-xxxl avatar-rounded mb-3">
                                                    <img src="<?php echo e(asset($teacher->profile_image)); ?>" alt="Teacher Photo">
                                                </span>
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                            <h6 class="fs-16 mb-1"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->middle_name); ?> <?php echo e($teacher->last_name); ?></h6>
                                        ...
                                        <div class="d-flex align-items-center gap-3 flex-wrap">
                                            <div class="flex-fill">
                                                <div class="bg-light border rounded p-2">
                                                    ...
                                                    <p class="mb-0"><?php echo e($teacher->dob ? \Carbon\Carbon::parse($teacher->dob)->format('d M Y') : 'N/A'); ?></p>
                                                </div>
                                            </div>
                                            <div class="flex-fill">
                                                <div class="bg-light border rounded p-2">
                                                    <h6 class="fw-semibold fs-14 mb-1">Gender</h6>
                                                    <p class="mb-0"><?php echo e($teacher->gender ?? 'N/A'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 d-flex">
                                <div class="card rounded-0 shadow flex-fill mb-0">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="<?php echo e(route('institution.teachers.edit', $teacher->id)); ?>" class="btn p-1 border-0 btn-outline-white">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <div class="bg-light border rounded d-flex align-items-center p-2 mb-3">
                                                ...
                                                <p class="mb-0 fs-13 text-dark"><?php echo e($teacher->phone ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="bg-light border rounded d-flex align-items-center p-2 mb-3">
                                                <span class="btn btn-icon btn-sm bg-white text-dark border flex-shrink-0 me-2">
                                                    <i class="ti ti-mail"></i>
                                                </span>
                                                <p class="mb-0 fs-13 text-dark"><?php echo e($teacher->email ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="bg-light border rounded d-flex align-items-center p-2 mb-3">
                                                <span class="btn btn-icon btn-sm bg-white text-dark border flex-shrink-0 me-2">
                                                    <i class="ti ti-map-pin"></i>
                                                </span>
                                                <p class="mb-0 fs-13 text-dark"><?php echo e($teacher->address ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="bg-light border rounded d-flex align-items-center p-2">
                                                <span class="btn btn-icon btn-sm bg-white text-dark border flex-shrink-0 me-2">
                                                    <i class="ti ti-hash"></i>
                                                </span>
                                                <p class="mb-0 fs-13 text-dark"><?php echo e($teacher->pincode ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="bg-light border rounded p-2 mb-2">
                                                    ...
                                                    <p class="mb-0"><?php echo e($teacher->caste_tribe ?? 'N/A'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                <span class="bg-light border py-1 px-2 rounded fs-13 fw-medium text-primary d-inline-flex">
                                                    <?php echo e($teacher->employee_id ?? 'N/A'); ?>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                <span class="bg-light border py-1 px-2 rounded fs-13 fw-medium text-primary d-inline-flex">
                                                    <?php echo e($teacher->institution->name ?? 'N/A'); ?>
                            ...
                            <div class="card shadow card-sm mb-3">
                                <div class="card-body">
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                <?php if($teacher->admin): ?>
                                                    <span class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                        <i class="ti ti-user"></i>
                                                    </span>
                                                    <p class="mb-0"><?php echo e($teacher->admin->name ?? 'N/A'); ?></p>
                                                <?php else: ?>
                    ...
                    <div class="tab-pane" id="nav_tab_3" role="tabpanel">
                        <div class="card rounded-0 mb-0">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="<?php echo e(route('institution.teachers.edit', $teacher->id)); ?>" class="btn btn-primary fs-12 py-1">
                                    ...
                                    <table class="table table-nowrap border">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(asset($teacher->profile_image)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
                                            <div>
                                                ...
                                                <p class="mb-0 fs-13"><?php echo e($teacher->created_at ? \Carbon\Carbon::parse($teacher->created_at)->format('d M Y') : 'N/A'); ?></p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                                            <div>
                                                <h6 class="fs-14 fw-semibold mb-1">Last Updated</h6>
                                                <p class="mb-0 fs-13"><?php echo e($teacher->updated_at ? \Carbon\Carbon::parse($teacher->updated_at)->format('d M Y') : 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card rounded-0 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            <a href="<?php echo e(route('institution.teachers.edit', $teacher->id)); ?>" class="btn btn-primary">
                                                <i class="ti ti-edit me-1"></i>Edit Teacher
                                            </a>
                                            <a href="<?php echo e(route('institution.teachers.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/institution/administration/teachers/show.blade.php ENDPATH**/ ?>