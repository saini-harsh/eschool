                    ...
                    <div class="tab-content" id="studentTabContent">
                        ...
                        <div class="tab-pane fade" id="document" role="tabpanel" aria-labelledby="document-tab">
                            <div class="row">
                                ...
                                <!-- Right Column - PAN and PEN Information -->
                                <div class="col-md-6">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function generateAdmissionAndRollNumbers() {
            const institutionId = document.querySelector('select[name="institution_id"]').value;
            ...
            if (institutionId && classId && sectionId) {
                ...
                fetch('/admin/students/generate-admission-number', {
                    method: 'POST',
                    headers: {
                ...
                fetch('/admin/students/generate-roll-number', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        // Add event listeners to institution, class, and section dropdowns
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (institutionSelect) {
                institutionSelect.addEventListener('change', generateAdmissionAndRollNumbers);
            }
            if (classSelect) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/admin/administration/students/create.blade.php ENDPATH**/ ?>