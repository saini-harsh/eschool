<?php $__env->startSection('title', 'Institution Dashboard | Attendance Management'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div>
                <a href="<?php echo e(route('institution.attendance.mark-page')); ?>" class="btn btn-primary">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('custom/js/institution/attendance.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/attendance/attendance.blade.php ENDPATH**/ ?>