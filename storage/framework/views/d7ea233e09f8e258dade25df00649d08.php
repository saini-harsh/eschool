<?php $__env->startSection('title', 'Institution | Edit Student'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div>
                ...
                <form id="studentForm" action="<?php echo e(route('institution.students.update', $student->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="tab-content" id="studentTabContent">
                        ...
                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group w-auto input-group-flat">
                                                        <input type="text" name="admission_date" class="form-control" data-provider="flatpickr"
                                                               ...
                                                               value="<?php echo e(old('admission_date', $student->admission_date ? \Carbon\Carbon::parse($student->admission_date)->format('d M, Y') : '')); ?>">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="group" class="form-control">
                                                        ...
                                                        <option value="Science" <?php echo e(old('group', $student->group) == 'Science' ? 'selected' : ''); ?>>Science</option>
                                                        <option value="Arts" <?php echo e(old('group', $student->group) == 'Arts' ? 'selected' : ''); ?>>Arts</option>
                                                        <option value="Commerce" <?php echo e(old('group', $student->group) == 'Commerce' ? 'selected' : ''); ?>>Commerce</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">ADMISSION NUMBER</label>
                                                    <input type="text" name="admission_number" class="form-control" value="<?php echo e(old('admission_number', $student->admission_number)); ?>" readonly>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">ROLL NUMBER</label>
                                                    <input type="text" name="roll_number" class="form-control" value="<?php echo e(old('roll_number', $student->roll_number)); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="address" class="form-control" rows="3" required><?php echo e(old('address', $student->address)); ?></textarea>
                            </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">PINCODE <span class="text-danger">*</span></label>
                                                    <input type="text" name="pincode" class="form-control" value="<?php echo e(old('pincode', $student->pincode)); ?>" required>
                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">DISTRICT <span class="text-danger">*</span></label>
                                                    <input type="text" name="district" class="form-control" value="<?php echo e(old('district', $student->district)); ?>" required>
                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">PERMANENT ADDRESS</label>
                                                    <textarea name="permanent_address" class="form-control" rows="3"><?php echo e(old('permanent_address', $student->permanent_address)); ?></textarea>
                                </div>
                                </div>
                                </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="first_name" class="form-control" value="<?php echo e(old('first_name', $student->first_name)); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">LAST NAME</label>
                                                    <input type="text" name="last_name" class="form-control" value="<?php echo e(old('last_name', $student->last_name)); ?>" required>
                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group w-auto input-group-flat">
                                                        <input type="text" name="dob" class="form-control" data-provider="flatpickr"
                                                               data-date-format="d M, Y" placeholder="dd/mm/yyyy" 
                                                               value="<?php echo e(old('dob', $student->dob ? \Carbon\Carbon::parse($student->dob)->format('d M, Y') : '')); ?>">
                                                        <span class="input-group-text"><i class="ti ti-calendar"></i></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="religion" class="form-control">
                                                        ...
                                                        <option value="Hinduism" <?php echo e(old('religion', $student->religion) == 'Hinduism' ? 'selected' : ''); ?>>Hinduism</option>
                                                        <option value="Christianity" <?php echo e(old('religion', $student->religion) == 'Christianity' ? 'selected' : ''); ?>>Christianity</option>
                                                        <option value="Buddhism" <?php echo e(old('religion', $student->religion) == 'Buddhism' ? 'selected' : ''); ?>>Buddhism</option>
                                                        <option value="Other" <?php echo e(old('religion', $student->religion) == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">CASTE</label>
                                    <input type="text" name="caste_tribe" class="form-control" value="<?php echo e(old('caste_tribe', $student->caste_tribe)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="category" class="form-control">
                                                        ...
                                                        <option value="General" <?php echo e(old('category', $student->category) == 'General' ? 'selected' : ''); ?>>General</option>
                                                        <option value="OBC" <?php echo e(old('category', $student->category) == 'OBC' ? 'selected' : ''); ?>>OBC</option>
                                                        <option value="SC" <?php echo e(old('category', $student->category) == 'SC' ? 'selected' : ''); ?>>SC</option>
                                                        <option value="ST" <?php echo e(old('category', $student->category) == 'ST' ? 'selected' : ''); ?>>ST</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">HEIGHT (CM)</label>
                                                    <input type="text" name="height" class="form-control" value="<?php echo e(old('height', $student->height)); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">WEIGHT (KG)</label>
                                                    <input type="text" name="weight" class="form-control" value="<?php echo e(old('weight', $student->weight)); ?>">
                                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="teacher_id" class="form-control" id="teacher_id">
                                                        ...
                                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('teacher_id', $student->teacher_id) == $teacher->id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="section_id" class="form-control" id="section_id">
                                                        ...
                                                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($section->id); ?>" <?php echo e(old('section_id', $student->section_id) == $section->id ? 'selected' : ''); ?>>
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="father_name" class="form-control" value="<?php echo e(old('father_name', $student->father_name)); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">FATHER OCCUPATION</label>
                                                    <input type="text" name="father_occupation" class="form-control" value="<?php echo e(old('father_occupation', $student->father_occupation)); ?>">
                                                </div>
                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">FATHER PHONE</label>
                                                    <input type="text" name="father_phone" class="form-control" value="<?php echo e(old('father_phone', $student->father_phone)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="mother_name" class="form-control" value="<?php echo e(old('mother_name', $student->mother_name)); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">MOTHER OCCUPATION</label>
                                                    <input type="text" name="mother_occupation" class="form-control" value="<?php echo e(old('mother_occupation', $student->mother_occupation)); ?>">
                                                </div>
                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">MOTHER PHONE</label>
                                                    <input type="text" name="mother_phone" class="form-control" value="<?php echo e(old('mother_phone', $student->mother_phone)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select name="guardian_relation" class="form-control" onchange="toggleGuardianRelationText(this.value)">
                                                        ...
                                                        <option value="Father" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Father' ? 'selected' : ''); ?>>Father</option>
                                                        <option value="Mother" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Mother' ? 'selected' : ''); ?>>Mother</option>
                                                        <option value="Grandfather" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Grandfather' ? 'selected' : ''); ?>>Grandfather</option>
                                                        <option value="Grandmother" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Grandmother' ? 'selected' : ''); ?>>Grandmother</option>
                                                        <option value="Uncle" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Uncle' ? 'selected' : ''); ?>>Uncle</option>
                                                        <option value="Aunt" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Aunt' ? 'selected' : ''); ?>>Aunt</option>
                                                        <option value="Other" <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                                </div>
                                                <div class="col-md-12 mb-3" id="guardian_relation_text_div" style="display: <?php echo e(old('guardian_relation', $student->guardian_relation) == 'Other' ? 'block' : 'none'); ?>;">
                                                    <label class="form-label">RELATION (OTHER)</label>
                                                    <input type="text" name="guardian_relation_text" class="form-control" value="<?php echo e(old('guardian_relation_text', $student->guardian_relation_text)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="guardian_occupation" class="form-control" value="<?php echo e(old('guardian_occupation', $student->guardian_occupation)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">GUARDIAN ADDRESS</label>
                                                    <textarea name="guardian_address" class="form-control" rows="3"><?php echo e(old('guardian_address', $student->guardian_address)); ?></textarea>
                                                </div>
                                                <div class="col-md-12 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="additional_notes" class="form-control" rows="4"><?php echo e(old('additional_notes', $student->additional_notes)); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="aadhaar_no" class="form-control" value="<?php echo e(old('aadhaar_no', $student->aadhaar_no)); ?>" placeholder="Enter 12-digit Aadhaar number">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if($student->aadhaar_front): ?>
                                                        <small class="text-muted">Current file: <?php echo e(basename($student->aadhaar_front)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if($student->aadhaar_back): ?>
                                                        <small class="text-muted">Current file: <?php echo e(basename($student->aadhaar_back)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="pan_no" class="form-control" value="<?php echo e(old('pan_no', $student->pan_no)); ?>" placeholder="Enter PAN number">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if($student->pan_front): ?>
                                                        <small class="text-muted">Current file: <?php echo e(basename($student->pan_front)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <?php if($student->pan_back): ?>
                                                        <small class="text-muted">Current file: <?php echo e(basename($student->pan_back)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="pen_no" class="form-control" value="<?php echo e(old('pen_no', $student->pen_no)); ?>" placeholder="Enter PEN number">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="bank_name" class="form-control" value="<?php echo e(old('bank_name', $student->bank_name)); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">BANK ACCOUNT NUMBER</label>
                                                    <input type="text" name="bank_account_number" class="form-control" value="<?php echo e(old('bank_account_number', $student->bank_account_number)); ?>">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">IFSC CODE</label>
                                                    <input type="text" name="ifsc_code" class="form-control" value="<?php echo e(old('ifsc_code', $student->ifsc_code)); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" name="document_01_title" class="form-control" value="<?php echo e(old('document_01_title', $student->document_01_title)); ?>">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" name="document_02_title" class="form-control" value="<?php echo e(old('document_02_title', $student->document_02_title)); ?>">
                                                    <div class="upload-area mt-2">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" name="document_03_title" class="form-control" value="<?php echo e(old('document_03_title', $student->document_03_title)); ?>">
                                                    <div class="upload-area mt-2">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" name="document_04_title" class="form-control" value="<?php echo e(old('document_04_title', $student->document_04_title)); ?>">
                                                    <div class="upload-area mt-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/institution/administration/students/edit.blade.php ENDPATH**/ ?>