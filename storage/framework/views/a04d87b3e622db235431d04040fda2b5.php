 ...
 <div
            ...
            <p class="text-dark mb-0">2025 &copy; <a href="javascript:void(0);" class="link-primary">EnvisionTechSolution</a>, All
                Rights Reserved</p>
            <p class="text-dark mb-0">Design & Developed by <a href="#" target="_blank"
                    class="link-primary">Gugun & Harsh</a></p>
        </div>
        <!-- Footer End -->
...
<!-- End Modal -->
<?php /**PATH F:\Github\envision\eschool\resources\views////elements/admin/footer.blade.php ENDPATH**/ ?>