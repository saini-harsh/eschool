            ...
            <div class="receipt-container">
                ...
                <div class="receipt-header">
                    ...
                    <div class="header-center">
                        ...
                        <p class="institution-address"><?php echo e($payment->institution->address); ?> <br><?php echo e($payment->institution->district); ?> District- <?php echo e($payment->institution->pincode); ?></p>
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-list">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <?php if(isset($payment->amount)): ?>
                                            <span class="value">₹<?php echo e(number_format($payment->amount, 2)); ?></span>
                                        <?php else: ?>
                                            <span class="value">₹<?php echo e(number_format($payment->payment_amount, 2)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <?php
                                    ...
                                    ?>
                                    <?php if(isset($payment->tuitionFeePayment ) || isset($payment->hostelPayment)): ?>
                                        <div class="info-item">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="value <?php echo e($pendingDue > 0 ? 'pending-due' : 'no-due'); ?>">
                                            ₹<?php echo e(number_format($pendingDue, 2)); ?>
                            ...
                            <div class="amount-section">
                                <div class="amount-box">
                                    ...
                                    <div class="amount-in-words">
                                        <small>
                                            <?php if(isset($payment->amount)): ?>
                                                (<?php echo e(ucwords(\App\Helpers\NumberHelper::toWords($payment->amount))); ?> Only)
                                            <?php else: ?>
                                                (<?php echo e(ucwords(\App\Helpers\NumberHelper::toWords($payment->payment_amount))); ?> Only)
                                            <?php endif; ?>
                                        </small>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/payment/payments/show.blade.php ENDPATH**/ ?>