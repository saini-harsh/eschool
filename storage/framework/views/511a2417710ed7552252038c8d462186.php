            ...
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                <?php if(PermissionHelper::canShowMenu('institutions')): ?>
                                <li class="">
                    ...
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.exam-management.marksheet*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('admin.exam-management.marksheet.index')); ?>">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="<?php echo e(request()->routeIs('admin.salary*') ? 'active subdrop' : ''); ?>">
                                <i class="ti ti-cash"></i><span>Salary Management</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.salary.structures*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('admin.salary.structures.index')); ?>">
                                        <i class="ti ti-list-details"></i><span>Salary Structures</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.salary.payments*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('admin.salary.payments.index')); ?>">
...
<!-- Sidenav Menu End -->
<?php /**PATH F:\Github\envision\eschool\resources\views////elements/admin/left-side-bar.blade.php ENDPATH**/ ?>