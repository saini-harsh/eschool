        ...
        <div>
            ...
            <a href="<?php echo e(route('institution.dashboard')); ?>" class="logo logo-normal">
                <?php if($institution->logo): ?>
                    <img src="<?php echo e(asset($institution->logo)); ?>" alt="Institution Logo" style="max-height: 40px;object-fit:contain;">
                <?php else: ?>
...
<!-- Sidenav Menu End -->
<?php /**PATH D:\school management software\eschool\resources\views////elements/institution/left-side-bar.blade.php ENDPATH**/ ?>