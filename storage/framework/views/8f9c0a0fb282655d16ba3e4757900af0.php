<?php $__env->startSection('title', 'Admin | Edit Student'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div>
                ...
                <form id="studentForm" action="<?php echo e(route('admin.students.update', $student->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="admission_number" class="form-control" value="<?php echo e(old('admission_number', $student->admission_number)); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Roll</label>
                                                    <input type="text" name="roll_number" class="form-control" value="<?php echo e(old('roll_number', $student->roll_number)); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="institution_id" class="form-control" id="institution_id" onchange="loadClasses(this.value); loadTeachers(this.value);">
                                                        <option value="">Institution</option>
                                                        <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($institution->id); ?>" <?php echo e(old('institution_id', $student->institution_id) == $institution->id ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/students/edit.blade.php ENDPATH**/ ?>