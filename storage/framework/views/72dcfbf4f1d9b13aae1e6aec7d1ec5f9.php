        ...
        <div class="col-lg-12 mx-auto">
            ...
            <div class="card mb-4 border-success">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-4">The admission form has been submitted and payment records have been created.</p>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <strong>Admission Date:</strong> <?php echo e($admission->admission_date ? \Carbon\Carbon::parse($admission->admission_date)->format('d M, Y') : 'N/A'); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 pb-3 border-bottom">
                                ...
                                <div class="mb-2">
                                    <strong>Payment Date:</strong> <?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M, Y')); ?>

                                </div>
                                <a href="<?php echo e(route('institution.student.admission.receipt.admission', [$admission->id, $payment->id])); ?>" 
                                   target="_blank" 
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 pb-3 border-bottom">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <strong>Receipt Number:</strong>
                                    <span class="badge bg-warning text-dark"><?php echo e($payment->receipt_number); ?></span>
                                </div>
                                <div class="mb-2">
                                ...
                                <a href="<?php echo e(route('institution.student.admission.receipt.tuition', [$admission->id, $payment->id])); ?>" 
                                   target="_blank" 
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="<?php echo e(route('institution.student.admission.print', $admission->id)); ?>" 
                           target="_blank" 
                           class="btn btn-primary btn-lg">
                            <i class="ti ti-printer me-2"></i>Print Admission Form
                        </a>
                        <a href="<?php echo e(route('institution.students.admission-form')); ?>" 
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/students/admission-success.blade.php ENDPATH**/ ?>