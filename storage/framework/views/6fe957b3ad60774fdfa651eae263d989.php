    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div>
                ...
                <form id="studentForm" action="<?php echo e(route('institution.students.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?> 
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="aadhaar_no" class="form-control" value="<?php echo e(old('aadhaar_no')); ?>" placeholder="Enter 12-digit Aadhaar number">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="pan_no" class="form-control" value="<?php echo e(old('pan_no')); ?>" placeholder="Enter PAN number">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" name="pen_no" class="form-control" value="<?php echo e(old('pen_no')); ?>" placeholder="Enter PEN number">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/administration/students/create.blade.php ENDPATH**/ ?>