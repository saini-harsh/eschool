                        ...
                        <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('teacher.routines*') || request()->routeIs('teacher.lesson-plans*') || request()->routeIs('teacher.assignments*') || request()->routeIs('teacher.classes*') || request()->routeIs('teacher.attendance*') ? 'active subdrop' : ''); ?>">
                            ...
                            <ul>
                              ...
                              <li class="">
                                ...
                                <?php if(PermissionHelper::canShowMenu('my_classes')): ?>
                                <li class="">
                                ...
                                <?php if(PermissionHelper::canShowMenu('lesson_plans')): ?>
                                <li class="">
...
<!-- Sidenav Menu End -->
<?php /**PATH F:\Github\envision\eschool\resources\views////elements/teacher/left-side-bar.blade.php ENDPATH**/ ?>