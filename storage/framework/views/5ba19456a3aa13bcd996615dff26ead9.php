                                    ...
                                    <div class="info-list">
                                        <div class="info-item">
                                            ...
                                            <span class="value"><span
                                                    class="fee-type"><?php echo e($payment->feeStructure->name ?? 'Admission Fee'); ?></span></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Fee Amount:</span>
                                            <span
                                                class="value">₹<?php echo e(number_format($payment->feeStructure->amount ?? $payment->amount, 2)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/administration/students/receipts/admission-receipt.blade.php ENDPATH**/ ?>