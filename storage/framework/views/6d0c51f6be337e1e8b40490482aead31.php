                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr" id="due_date" name="due_date" value="<?php echo e($feeStructure->due_date->format('Y-m-d')); ?>" placeholder="Select due date" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/payment/fee-structure/edit.blade.php ENDPATH**/ ?>