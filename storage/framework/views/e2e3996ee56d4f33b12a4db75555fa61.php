<?php $__env->startSection('title', 'Teacher Settings'); ?>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="avatar avatar-xxl border border-dashed position-relative me-3 flex-shrink-0 p-2">
                                            <div class="d-felx align-items-center">
                                                <img src="<?php echo e($teacher->profile_image ? asset($teacher->profile_image) : asset('/adminpanel/img/users/avatar-2.jpg')); ?>" 
                                    ...
                                    <div class="row row-gap-3">
                                        <div class="col-lg-4">
                                            <div class="mb-0">
                                                ...
                                                <input type="text" class="form-control" name="first_name" value="<?php echo e($teacher->first_name ?? ''); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-0">
                                                <label class="form-label">Middle Name</label>
                                                <input type="text" class="form-control" name="middle_name" value="<?php echo e($teacher->middle_name ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-0">
                                                <label class="form-label">Last Name<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="last_name" value="<?php echo e($teacher->last_name ?? ''); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <input type="date" class="form-control" name="dob" value="<?php echo e($teacher->dob ? $teacher->dob->format('Y-m-d') : ''); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <input type="text" class="form-control" name="caste_tribe" value="<?php echo e($teacher->caste_tribe ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="<?php echo e($teacher->employee_id ?? 'Not Assigned'); ?>" readonly>
                                    ...
                                    <div class="row row-gap-3">
                                        <div class="col-lg-12">
                                            <div class="mb-0">
                                                ...
                                                <textarea class="form-control" name="address" rows="3" required><?php echo e($teacher->address ?? ''); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Pin Code<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="pincode" value="<?php echo e($teacher->pincode ?? ''); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Institution Code</label>
                                                <input type="text" class="form-control" value="<?php echo e($teacher->institution_code ?? ''); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
const profileUpdateUrl = '<?php echo e(route("teacher.settings.profile")); ?>';
const passwordUpdateUrl = '<?php echo e(route("teacher.settings.change-password")); ?>';
const deleteImageUrl = '<?php echo e(route("teacher.settings.delete-profile-image")); ?>';
const defaultImageUrl = '<?php echo e(asset("/adminpanel/img/users/avatar-2.jpg")); ?>';
</script>
<script src="<?php echo e(asset('custom/js/teacher/settings.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/teacher/settings/index.blade.php ENDPATH**/ ?>