    ...
    <div class="content">
                                                ...
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            <?php echo e(in_array('cash', (array) request('payment_method', [])) ? 'checked' : ''); ?>>
                                                        Cash
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            <?php echo e(in_array('online', (array) request('payment_method', [])) ? 'checked' : ''); ?>>
                                                        Online
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            <?php echo e(in_array('bank_transfer', (array) request('payment_method', [])) ? 'checked' : ''); ?>>
                                                        Bank Transfer
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            <?php echo e(in_array('cheque', (array) request('payment_method', [])) ? 'checked' : ''); ?>>
                                                        Cheque
                                                    </label>
                                                </li>
                                            </ul>
                                                    ...
                                                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <label
                                                                ...
                                                                <input class="form-check-input m-0 me-2" type="checkbox"
                                                                    name="class_section[]" value="<?php echo e($class->id); ?>_all"
                                                                    <?php echo e(in_array($class->id . '_all', (array) request('class_section', [])) ? 'checked' : ''); ?>>
                                                                ...
                                                                <li>
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input m-0 me-2"
                                                                            type="checkbox" name="class_section[]"
                                                                            value="<?php echo e($class->id); ?>_<?php echo e($section->id); ?>"
                                                                            <?php echo e(in_array($class->id . '_' . $section->id, (array) request('class_section', [])) ? 'checked' : ''); ?>>
        ...
        <?php if($payments->count() > 0): ?>
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h6 class="mb-0">Showing <?php echo e($payments->firstItem()); ?> to <?php echo e($payments->lastItem()); ?> of
                        <?php echo e($payments->total()); ?> payments</h6>
                </div>
                <div>
                                ...
                                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0"><?php echo e($payment->feeStructure->name ?? 'N/A'); ?>

                                                    </h6>
                                                    <small
                                                        class="text-muted"><?php echo e($payment->feeStructure->schoolClass->name ?? 'N/A'); ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0 text-success fw-bold">
                                                        ₹<?php echo e(number_format($payment->amount, 2)); ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <span
                                                        class="badge bg-<?php echo e($payment->payment_method == 'cash' ? 'success' : ($payment->payment_method == 'online' ? 'primary' : ($payment->payment_method == 'bank_transfer' ? 'info' : 'secondary'))); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0"><?php echo e($payment->payment_date->format('d M Y')); ?>
                ...
                sortDropdown.querySelectorAll('a.dropdown-item').forEach(function(sortLink) {
                    sortLink.addEventListener('click', function(e) {
                        ...
                        const sortButton = document.querySelector(
                            '.dropdown:last-child [data-bs-toggle="dropdown"]');
                        if (sortButton) {
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/payment/payments/index.blade.php ENDPATH**/ ?>