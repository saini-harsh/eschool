        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div>
                    ...
                    <form id="studentForm" action="<?php echo e(route('institution.students.store')); ?>" method="POST"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="2025|2025"
                                                            readonly>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="class_id" class="form-control" id="class_id"
                                                            ...
                                                            <option value="<?php echo e($class->id); ?>" <?php echo e(old('previous_school_class') == $class->id ? 'selected' : ''); ?>>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="previous_school_name" id="previous_school_name"
                                                            class="form-control" value="" placeholder="Enter Previous School Name">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label"> SCHOOL ADDRESS</label>
                                                        <input type="text" name="previous_school_address" id="previous_school_address"
                                                            class="form-control" value="" placeholder="Enter Previous School Address">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label"> CLASS</label>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="previous_school_result" id="previous_school_result"
                                                            class="form-control" value="" placeholder="Enter Previous School Result">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="permanent_pincode" class="form-control"
                                                            value="<?php echo e(old('permanent_pincode')); ?>" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label"> DISTRICT <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" name="permanent_district" class="form-control"
                                                            value="<?php echo e(old('permanent_district')); ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <input type="file" name="parent_aadhaar_front" class="form-control"
                                                            accept="image/*">
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">AADHAAR CARD BACK</label>
                                                        <input type="file" name="parent_aadhaar_back" class="form-control"
                                                            accept="image/*">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">AADHAAR CARD FRONT</label>
                                                        <input type="file" name="guardian_aadhaar_front" class="form-control"
                                                            accept="image/*">
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">AADHAAR CARD BACK</label>
                                                        <input type="file" name="guardian_aadhaar_back" class="form-control"
                                                            accept="image/*">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <p>Admission Fee: <span class="text-primary">₹ 3700</span></p>
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">PAYMENT AMOUNT</label>
                                                        <input type="number" name="payment_amount" class="form-control"
                                                            value="<?php echo e(old('payment_amount')); ?>" placeholder="Enter Payment Amount">
                                                    </div>
                                                    <div class="col-md-12 mb-3">
                                                    ...
                                                    <p>Due: <span class="text-primary">₹ 3700</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <p>Tuition Fee: <span class="text-primary">₹ 3700</span></p>
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">PAYMENT AMOUNT</label>
                                                        <input type="number" name="payment_amount" class="form-control"
                                                            value="<?php echo e(old('payment_amount')); ?>" placeholder="Enter Payment Amount">
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/administration/students/admission-form.blade.php ENDPATH**/ ?>