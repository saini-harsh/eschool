...
<?php $__env->startSection('title', 'Teacher | Events'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span class="text-muted fs-12"><?php echo e(Auth::guard('teacher')->user()->institution->name ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // Load events
    function loadEvents() {
        fetch('<?php echo e(route("teacher.events.api")); ?>')
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/teacher/academic/events/index.blade.php ENDPATH**/ ?>