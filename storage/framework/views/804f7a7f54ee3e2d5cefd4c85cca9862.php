                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="avatar avtar-lg bg-teal mb-2"><img
                                                src="<?php echo e(asset('adminpanel/img/icons/dashboard-card-icon-01.svg')); ?>"
                                                class="w-auto h-auto" alt="Icon"></div>
                                        <h6 class="fs-14 fw-semibold mb-0">Students</h6>
                                        <div class="fs-18 fw-bold"><?php echo e(number_format($stats['students'] ?? 0)); ?></div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <div class="fs-18 fw-bold"><?php echo e(number_format($stats['teachers'] ?? 0)); ?></div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <div class="fs-18 fw-bold"><?php echo e(number_format($stats['institutions'] ?? 0)); ?></div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <div class="fs-18 fw-bold"><?php echo e(number_format($stats['classes'] ?? 0)); ?></div>
                                    </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <a href="<?php echo e(route('admin.attendance.scan-page')); ?>" class="card border-primary text-decoration-none h-100">
                                    ...
                                    <div class="col-md-4">
                                        <a href="<?php echo e(route('admin.attendance.mark-page')); ?>" class="card border-success text-decoration-none h-100">
                                            <div class="card-body text-center">
                                    ...
                                    <div class="col-md-4">
                                        <a href="<?php echo e(route('admin.attendance')); ?>" class="card border-info text-decoration-none h-100">
                                            <div class="card-body text-center">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="mb-1">
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-1"><?php echo e(number_format($stats['sections'] ?? 0)); ?></h6>
                                        </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="mb-1">
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-1"><?php echo e(number_format($stats['subjects'] ?? 0)); ?></h6>
                                        </div>
                                        <p class="fs-12 text-truncate text-dark mb-0"><span class="text-success me-1"><i
                                                    class="ti ti-trending-up"></i></span>+1.4% from last week</p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <div class="mb-1">
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-1"><?php echo e(number_format($stats['assignments'] ?? 0)); ?></h6>
                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="index-profile text-center">
                            <img src="<?php echo e(asset('adminpanel/img/users/user-05.jpg')); ?>" alt="img"
                                class="avatar avatar-xxl rounded-circle shadow">
                            <div class="text-center mb-0">
                                <h5 class="fw-bold mb-1">Welcome Admin</h5>
                                <p class="mb-0"><?php echo e($stats['dateToday'] ?? ''); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="card shadow flex-fill">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-01.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-02.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-03.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-04.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-05.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="employee-details.html" class="avatar avatar-sm avatar-rounded flex-shrink-0">
                                        <img src="<?php echo e(asset('adminpanel/img/employees/employee-06.jpg')); ?>" alt="img">
                                    </a>
                                    <div class="ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    ...
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-03.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-06.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/managers/manager-07.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-08.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/managers/manager-05.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-09.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0"><a href="employee-details.html">Daniel
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-04.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/managers/manager-03.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0"><a href="employee-details.html">Daniel
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="javascript:void(0);" class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/employees/employee-02.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="employee-details.html"
                                                    class="avatar avatar-sm avatar-rounded">
                                                    <img src="<?php echo e(asset('adminpanel/img/managers/manager-09.jpg')); ?>"
                                                        alt="img">
                                                </a>
                                                <div class="ms-2">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/employees/employee-10.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/employees/employee-09.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/employees/employee-08.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/managers/manager-09.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/managers/manager-10.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/managers/manager-03.jpg')); ?>" alt=""></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <span
                            ...
                            <span class="avatar avatar-sm avatar-rounded"><img
                                    src="<?php echo e(asset('adminpanel/img/managers/manager-06.jpg')); ?>" alt=""></span>
                        </div>
                    </div>
                </div>
            </div><!-- end col -->
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/admin/index.blade.php ENDPATH**/ ?>