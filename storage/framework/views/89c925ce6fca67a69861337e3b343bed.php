<?php $__env->startSection('title', 'Admin | Add Institution'); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto">
                ...
                <!-- <?php if($errors->any()): ?>
                    ...
                    <?php endif; ?> -->
                    <h6 class="mb-3 fs-14"><a href="<?php echo e(route('admin.institutions.index')); ?>"><i class="ti ti-arrow-left me-1"></i>Institutions</a></h6>
                    <form action="<?php echo e(route('admin.institutions.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/institutions/create.blade.php ENDPATH**/ ?>