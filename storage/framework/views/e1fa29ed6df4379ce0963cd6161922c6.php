<?php $__env->startSection('title', 'Admin | Edit Teacher'); ?>
...
<div class="content">
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div>
                <h6 class="mb-3 fs-14">
                    <a href="<?php echo e(route('admin.teachers.index')); ?>"><i class="ti ti-arrow-left me-1"></i>Back to Teachers</a>
                </h6>
                <!-- <?php if($errors->any()): ?>
                ...
                <form action="<?php echo e(route('admin.teachers.update', $teacher->id)); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select name="institution_id" class="select">
                                        <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($institution->id); ?>"
                                                <?php echo e($teacher->institution_id == $institution->id ? 'selected' : ''); ?>>
                    ...
                    <div class="d-flex align-items-center justify-content-end mt-3">
                        <a href="<?php echo e(route('admin.teachers.index')); ?>" class="btn btn-light me-2">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/teachers/edit.blade.php ENDPATH**/ ?>