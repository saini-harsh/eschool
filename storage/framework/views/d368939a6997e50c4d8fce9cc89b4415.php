<?php $__env->startSection('title', 'Fee Structure Management'); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $feeStructures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeStructure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <div>
                                            <h6 class="mb-0"><?php echo e($feeStructure->fee_name); ?></h6>
                                    ...
                                    <td>
                                        <span class="fw-bold text-success">₹<?php echo e(number_format($feeStructure->amount, 2)); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-info"><?php echo e(ucfirst($feeStructure->fee_type)); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e(ucfirst($feeStructure->payment_frequency)); ?></span>
                                    </td>
                                    <td>
                                        <span class="fw-bold <?php echo e($feeStructure->getDueDateStatus() == 'overdue' ? 'text-danger' : ($feeStructure->getDueDateStatus() == 'due_today' ? 'text-warning' : 'text-success')); ?>">
                                            <?php echo e($feeStructure->getFormattedDueDate()); ?>

                                        </span>
                                        <?php if($feeStructure->getDueDateStatus() == 'due_soon'): ?>
                                            <br><small class="text-warning">
                                                <i class="ti ti-clock me-1"></i>
                                                Due in <?php echo e(abs($feeStructure->getDaysUntilDue())); ?> days
                                            </small>
                                        <?php elseif($feeStructure->getDueDateStatus() == 'overdue'): ?>
                                            <br><small class="text-danger">
                                                <i class="ti ti-alert-circle me-1"></i>
                                                Overdue by <?php echo e(abs($feeStructure->getDaysUntilDue())); ?> days
                                            </small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" 
                                                       href="<?php echo e(route('institution.fee-structure.edit', $feeStructure)); ?>">
                                                        <i class="ti ti-edit me-2"></i>Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" 
                                                       href="<?php echo e(route('institution.fee-structure.invoice', $feeStructure)); ?>">
                                                        <i class="ti ti-receipt me-2"></i>View Invoice
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" 
                                                       href="<?php echo e(route('institution.fee-structure.download-invoice', $feeStructure)); ?>">
                                                        <i class="ti ti-download me-2"></i>Download PDF
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="<?php echo e(route('institution.fee-structure.destroy', $feeStructure)); ?>" 
                                                          method="POST" 
                                                          class="d-inline"
