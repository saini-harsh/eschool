...
<?php $__env->startSection('title', 'Institution | Manage Permissions - ' . $student->first_name . ' ' . $student->last_name); ?>
            ...
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('institution.students.index')); ?>">Students</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Permissions</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="<?php echo e(route('institution.students.index')); ?>" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('institution.students.permissions.update', $student->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    <a href="<?php echo e(route('institution.students.index')); ?>" class="btn btn-outline-primary me-2">Cancel</a>
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/institution/administration/students/permissions.blade.php ENDPATH**/ ?>