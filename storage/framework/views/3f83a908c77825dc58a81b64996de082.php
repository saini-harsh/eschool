                            ...
                            <div class="col-xl-6 d-flex">
                                <div class="card rounded-0 shadow flex-fill mb-0">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="btn p-1 border-0 btn-outline-white">
                    ...
                    <div class="tab-pane" id="nav_tab_3" role="tabpanel">
                        <div class="card rounded-0 mb-0">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="btn btn-primary fs-12 py-1">
                                ...
                                <div class="card rounded-0 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-2">
                                            <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/admin/administration/teachers/show.blade.php ENDPATH**/ ?>