        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.dashboard*') ? 'active subdrop' : ''); ?>">
                                <i class="ti ti-layout-dashboard"></i><span>Dashboard</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li><a href="#" class="<?php echo e(request()->routeIs('admin.dashboard*') ? 'active' : ''); ?>">Dashboard</a></li>
                            </ul>
                        </li>
                        <!-- <li class="submenu">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.institutions*') || request()->routeIs('admin.teachers*') || request()->routeIs('admin.students*') || request()->routeIs('admin.nonworkingstaff*') || request()->routeIs('admin.attendance*') ? 'active subdrop' : ''); ?>">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.institutions*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.institutions.index')); ?>">
                                        <i class="ti ti-building-community"></i><span>Insitutions</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.teachers*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.teachers.index')); ?>">
                                        <i class="ti ti-users-group"></i><span>Teachers</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.students*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.students.index')); ?>">
                                        <i class="ti ti-users-group"></i><span>Students</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.nonworkingstaff*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.nonworkingstaff.index')); ?>">
                                        <i class="ti ti-users-group"></i><span>Non-Working Staff</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.attendance*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.attendance')); ?>">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.classes*') || request()->routeIs('admin.sections*') || request()->routeIs('admin.subjects*') || request()->routeIs('admin.academic.assign-teacher*') || request()->routeIs('admin.assign-subject*') || request()->routeIs('admin.academic.calendar*') || request()->routeIs('admin.events*') ? 'active subdrop' : ''); ?>">
                            ...
                            <li class="">
                                <a class="<?php echo e(request()->routeIs('admin.classes*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.classes.index')); ?>">
                                    <i class="ti ti-report"></i><span>Class</span>
                                </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.sections*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.sections.index')); ?>">
                                        <i class="ti ti-menu-2"></i><span>Section</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.subjects*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.subjects.index')); ?>">
                                        <i class="ti ti-book"></i><span>Subject</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.academic.assign-teacher*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.academic.assign-teacher.index')); ?>">
                                        <i class="ti ti-user"></i><span>Assign Class Teacher</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.assign-subject*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.assign-subject.index')); ?>">
                                        <i class="ti ti-checks"></i><span>Assign Subject</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.academic.calendar*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.academic.calendar.index')); ?>">
                                        <i class="ti ti-calendar"></i><span>Calendar</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.events*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.events.index')); ?>">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.email-sms*') ? 'active subdrop' : ''); ?>">
                                <i class="ti ti-layout-dashboard"></i><span>Communication</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.email-sms*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.email-sms.index')); ?>">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.rooms*') || request()->routeIs('admin.invigilators*') || request()->routeIs('admin.exam-management*') ? 'active subdrop' : ''); ?>">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.exam-management.exam-type') ? 'active' : ''); ?>" href="<?php echo e(route('admin.exam-management.exam-type')); ?>">
                                        <i class="ti ti-home"></i><span>Exam Type</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.exam-management.exam-setup') ? 'active' : ''); ?>" href="<?php echo e(route('admin.exam-management.exam-setup')); ?>">
                                        <i class="ti ti-home"></i><span>Exam Setup</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.rooms*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.rooms.index')); ?>">
                                        <i class="ti ti-home"></i><span>Class Rooms</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.invigilators*') ? 'active' : ''); ?>" href="#">
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('admin.routines*') || request()->routeIs('admin.lesson-plans*') ? 'active subdrop' : ''); ?>">
                                <i class="ti ti-layout-dashboard"></i><span>Routine</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.routines*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.routines.index')); ?>">
                                        <i class="ti ti-calendar-event"></i><span>Class Routine</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('admin.lesson-plans*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.lesson-plans.index')); ?>">
                ...
                <li>
                    <ul>
                        <li class="">
                            <a class="<?php echo e(request()->routeIs('admin.settings*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.index')); ?>">
        ...
        <div class="sidebar-footer">
            <div class="bg-light p-2 rounded d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="fs-13 mb-0"><a href="mailto:<?php echo e($admin->email); ?>"
                            class="__cf_email__"
