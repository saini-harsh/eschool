    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div>
                    <h6 class="mb-3 fs-14"><a href="<?php echo e(route('institution.students.index')); ?>"><i
                                ...
                                <div class="card rounded-0 shadow flex-fill mb-xl-0">
                                    <div class="card-body">
                                        <div class="text-center mb-3">
                                            ...
                                            <?php endif; ?>
                                            <h6 class="fs-16 mb-1"><?php echo e($student->first_name); ?> <?php echo e($student->middle_name); ?>

                                                <?php echo e($student->last_name); ?></h6>
                                        ...
                                        <div class="d-flex align-items-center gap-3 flex-wrap">
                                            ...
                                            <div class="flex-fill">
                                                <div class="bg-light border rounded p-2">
                                                    ...
                                                    <p class="mb-0">
                                                        <?php echo e($student->dob ? \Carbon\Carbon::parse($student->dob)->format('d M Y') : 'N/A'); ?>
                            ...
                            <div class="col-xl-6 d-flex">
                                <div class="card rounded-0 shadow flex-fill mb-0">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="<?php echo e(route('institution.students.edit', $student->id)); ?>"
                                                    ...
                                                    <table class="table table-sm table-bordered mb-0">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $siblings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sibling): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    <td>
                                                                        <?php if($sibling->photo): ?>
                                                                            <span class="avatar avatar-sm avatar-rounded">
                                                                                <img src="<?php echo e(asset($sibling->photo)); ?>"
                                                                                    alt="Sibling Photo">
                                                                            </span>
                                                                        <?php else: ?>
                                                                            <span
                                                                    ...
                                                                    <td class="fs-13 align-middle">
                                                                        <?php echo e($sibling->student_id); ?></td>
                                                                    <td class="fs-13 align-middle">
                                                                        <?php echo e($sibling->first_name); ?>

                                                                        <?php echo e($sibling->last_name); ?></td>
                                                                    <td class="fs-13 align-middle">
                                                                        <?php echo e($sibling->schoolClass->name ?? 'N/A'); ?></td>
                                                                    <td class="fs-13 align-middle">
                                                                        <?php echo e($sibling->section->name ?? 'N/A'); ?></td>
                                                                    <td class="text-center align-middle">
                                                                        <a href="<?php echo e(route('institution.students.show', $sibling->id)); ?>"
                                                ...
                                                <?php if($student->teacher): ?>
                                                    <span class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2">
                                                        <?php if($student->teacher->photo): ?>
                                                            <img src="<?php echo e(asset($student->teacher->photo)); ?>"
                                                                alt="">
                                                        <?php else: ?>
                                                            <i class="ti ti-user"></i>
                                                        <?php endif; ?>
                                                    </span>
                                                    <p class="mb-0"><?php echo e($student->teacher->first_name); ?>

                                                        <?php echo e($student->teacher->last_name); ?></p>
                                                <?php else: ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 text-center">
                                                <?php if($student->guardian_photo): ?>
                                                    <span class="avatar avatar-xl avatar-rounded mb-3">
                                                        <img src="<?php echo e(asset($student->guardian_photo)); ?>"
                                                            alt="Guardian Photo">
                                                    </span>
                                                <?php else: ?>
                                                    <span class="avatar avatar-xl avatar-rounded mb-3 bg-light border">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="bg-light border rounded p-2 mb-2">
                                                            ...
                                                            <p class="mb-0"><?php echo e($student->guardian_relation ?? 'N/A'); ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="bg-light border rounded p-2 mb-2">
                                                            <h6 class="fw-semibold fs-14 mb-1">Occupation</h6>
                                                            <p class="mb-0"><?php echo e($student->guardian_occupation ?? 'N/A'); ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="bg-light border rounded p-2">
                                                            ...
                                                            <p class="mb-0"><?php echo e($student->guardian_address ?? 'N/A'); ?>
                                                        ...
                                                        <?php if($student->aadhaar_front): ?>
                                                            <div class="col-6">
                                                                <div class="text-center">
                                                                    ...
                                                                    <img src="<?php echo e(asset($student->aadhaar_front)); ?>"
                                                                        alt="Aadhaar Front"
                                                                        class="img-fluid border rounded"
                                                                        style="max-height: 150px; width: 100%; object-fit: cover;">
                                                                    <a href="<?php echo e(asset($student->aadhaar_front)); ?>"
                                                                        target="_blank"
                                                        ...
                                                        <?php if($student->aadhaar_back): ?>
                                                            <div class="col-6">
                                                                <div class="text-center">
                                                                    ...
                                                                    <img src="<?php echo e(asset($student->aadhaar_back)); ?>"
                                                                        alt="Aadhaar Back"
                                                                        class="img-fluid border rounded"
                                                                        style="max-height: 150px; width: 100%; object-fit: cover;">
                                                                    <a href="<?php echo e(asset($student->aadhaar_back)); ?>"
                                                                        target="_blank"
                                                                        class="btn btn-sm btn-outline-secondary mt-2">
                                                                        <i class="ti ti-external-link me-1"></i>Open
                                                                    </a>
                                                    ...
                                                    <div class="row">
                                                        <?php if($student->pan_front): ?>
                                                            <div class="col-6">
                                                                <div class="text-center">
                                                                    <strong class="d-block mb-2">Front</strong>
                                                                    <img src="<?php echo e(asset($student->pan_front)); ?>"
                                                                        alt="PAN Front" class="img-fluid border rounded"
                                                                        style="max-height: 150px; width: 100%; object-fit: cover;">
                                                                    <a href="<?php echo e(asset($student->pan_front)); ?>"
                                                                        target="_blank"
                                                                        class="btn btn-sm btn-outline-secondary mt-2">
                                                                        <i class="ti ti-external-link me-1"></i>Open
                                                                    </a>
                                                        ...
                                                        <?php if($student->pan_back): ?>
                                                            <div class="col-6">
                                                                <div class="text-center">
                                                                    <strong class="d-block mb-2">Back</strong>
                                                                    <img src="<?php echo e(asset($student->pan_back)); ?>"
                                                                        alt="PAN Back" class="img-fluid border rounded"
                                                                        style="max-height: 150px; width: 100%; object-fit: cover;">
                                                                    <a href="<?php echo e(asset($student->pan_back)); ?>"
                                                                        target="_blank"
                                                                        class="btn btn-sm btn-outline-secondary mt-2">
                                                                        <i class="ti ti-external-link me-1"></i>Open
                                                                    </a>
                                        ...
                                        <tbody>
                                            <?php if($student->document_01_file): ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14">
                                                            <?php echo e($student->document_01_title ?? 'Document 01'); ?></h6>
                                                    </td>
                                                    <td>
                                                        <i class="ti ti-file-type-pdf fs-20 text-danger"></i>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(asset($student->document_01_file)); ?>" target="_blank"
                                            ...
                                            <?php if($student->document_02_file): ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14">
                                                            <?php echo e($student->document_02_title ?? 'Document 02'); ?></h6>
                                                    </td>
                                                    <td>
                                                        <i class="ti ti-file-type-pdf fs-20 text-danger"></i>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(asset($student->document_02_file)); ?>" target="_blank"
                                                            class="btn btn-sm btn-outline-primary">
                                                            <i class="ti ti-download me-1"></i>Download
                                                        </a>
                                                    </td>
                                            ...
                                            <?php if($student->document_03_file): ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14">
                                                            <?php echo e($student->document_03_title ?? 'Document 03'); ?></h6>
                                                    </td>
                                                    <td>
                                                        <i class="ti ti-file-type-pdf fs-20 text-danger"></i>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(asset($student->document_03_file)); ?>" target="_blank"
                                                            class="btn btn-sm btn-outline-primary">
                                                            <i class="ti ti-download me-1"></i>Download
                                                        </a>
                                                    </td>
                                            ...
                                            <?php if($student->document_04_file): ?>
                                                <tr>
                                                    <td>
                                                        <h6 class="mb-0 fs-14">
                                                            <?php echo e($student->document_04_title ?? 'Document 04'); ?></h6>
                                                    </td>
                                                    <td>
                                                        <i class="ti ti-file-type-pdf fs-20 text-danger"></i>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(asset($student->document_04_file)); ?>" target="_blank"
                                                            class="btn btn-sm btn-outline-primary">
                                                            <i class="ti ti-download me-1"></i>Download
                                                        </a>
                                                    </td>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card rounded-0 shadow mb-0">
                                    ...
                                    <div class="card-body">
                                        <?php if(!empty($paymentsByMonth) && count($paymentsByMonth) > 0): ?>
                                            <?php $__currentLoopData = $paymentsByMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="mb-4">
                                                    <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                                                        <h6 class="mb-0 fw-bold text-primary">
                                                            <i class="ti ti-calendar me-2"></i><?php echo e($monthData['month']); ?>

                                                        </h6>
                                                        <div>
                                                            <span class="badge badge-soft-success fs-14">
                                                                Total: ₹<?php echo e(number_format($monthData['total_amount'], 2)); ?>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-sm table-bordered mb-0">
                                                            ...
                                                            <tbody>
                                                                <?php $__currentLoopData = $monthData['payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td class="fs-13">
                                                                        ...
                                                                        <td class="fs-13">
                                                                            <span class="badge badge-soft-info"><?php echo e($payment['type']); ?></span>
                                                                            <?php if(isset($payment['months'])): ?>
                                                                                <br><small class="text-muted"><?php echo e($payment['months']); ?></small>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                        <td class="fs-13"><?php echo e($payment['fee_structure']); ?></td>
                                                                        <td class="fs-13 fw-semibold">₹<?php echo e(number_format($payment['amount'], 2)); ?></td>
                                                                        <td class="fs-13">
                                                                            <?php if($payment['discount'] > 0): ?>
                                                                                <span class="text-success">-₹<?php echo e(number_format($payment['discount'], 2)); ?></span>
                                                                            <?php else: ?>
                                                                        ...
                                                                        <td class="fs-13">
                                                                            <span class="badge badge-soft-primary">
                                                                                <?php echo e(ucfirst(str_replace('_', ' ', $payment['method']))); ?>

                                                                            </span>
                                                                        </td>
                                                                        <td class="fs-13">
                                                                            <code class="text-primary"><?php echo e($payment['receipt']); ?></code>
                                                                        </td>
                                                                        <td class="fs-13">
                                                                            ...
                                                                            <?php else: ?>
                                                                                <span class="badge badge-soft-secondary"><?php echo e(ucfirst($payment['status'])); ?></span>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/students/show.blade.php ENDPATH**/ ?>