                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <a href="<?php echo e(route('teacher.attendance.scan-page')); ?>" class="card border-primary text-decoration-none h-100">
                                ...
                                <div class="col-md-4">
                                    <a href="<?php echo e(route('teacher.attendance.mark-page')); ?>" class="card border-success text-decoration-none h-100">
                                        <div class="card-body text-center">
                                ...
                                <div class="col-md-4">
                                    <a href="<?php echo e(route('teacher.attendance')); ?>" class="card border-info text-decoration-none h-100">
                                        <div class="card-body text-center">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="index-profile text-center">
                        <img src="<?php echo e($teacher->profile_image ? asset($teacher->profile_image) : ''); ?>" alt="img" class="avatar avatar-xxl rounded-circle shadow">
                        <div class="text-center mb-0">
                            <h5 class="fw-bold mb-1">Welcome <?php echo e(Auth::guard('teacher')->user()->first_name); ?></h5>
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('<?php echo e(route('teacher.dashboard.data')); ?>')
        .then(res => res.json())
        .then(data => {
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/teacher/index.blade.php ENDPATH**/ ?>