 ...
 <header class="navbar-header">
     <div class="page-container topbar-menu">
         ...
         <div class="d-flex align-items-center">
             ...
             <div class="header-item">
                 <div class="me-2">
                     <a href="<?php echo e(route('teacher.events.index')); ?>" class="btn topbar-link"><i
             ...
             <div class="header-item">
                 <div>
                     <a href="<?php echo e(route('teacher.settings.index')); ?>" class="btn topbar-link"><i class="ti ti-settings fs-16"></i></a>
                 </div>
             </div>
...
<?php /**PATH F:\Github\envision\eschool\resources\views////elements/teacher/header.blade.php ENDPATH**/ ?>