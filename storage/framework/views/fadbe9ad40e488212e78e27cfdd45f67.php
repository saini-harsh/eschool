<?php $__env->startSection('title', 'Admin Dashboard | Scan Attendance'); ?>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="<?php echo e(route('admin.attendance')); ?>"><i class="ti ti-arrow-left me-1"></i>Attendance
                                Management</a>
                        </li>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('custom/js/admin/scan-attendance.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/admin/administration/attendance/scan-attendance.blade.php ENDPATH**/ ?>