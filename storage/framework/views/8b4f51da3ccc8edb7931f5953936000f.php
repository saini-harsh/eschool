    ...
    <div class="sidebar-inner" data-simplebar>
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <?php if(PermissionHelper::canShowMenu('exams') || PermissionHelper::canShowMenu('results')): ?>
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('student.exam*') ? 'active subdrop' : ''); ?>">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('student.exams*') ? 'active' : ''); ?>" href="<?php echo e(route('student.exams.index')); ?>">
                                        <i class="ti ti-report"></i><span>Routine</span>
                                    </a>
                                </li>
                                <?php endif; ?>

                                <?php if(PermissionHelper::canShowMenu('results')): ?>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('student.coming-soon*') ? 'active' : ''); ?>" href="<?php echo e(route('student.coming-soon')); ?>">
...
<!-- Sidenav Menu End -->
<?php /**PATH F:\Github\envision\eschool\resources\views////elements/student/left-side-bar.blade.php ENDPATH**/ ?>