                        ...
                        <div class="mb-3">
                            ...
                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    <input type="checkbox" name="section_ids[]" value="<?php echo e($section->id); ?>"
                                        class="form-check-input section-checkbox" id="section_<?php echo e($section->id); ?>">
                                    <label class="form-check-label" for="section_<?php echo e($section->id); ?>">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <select class="form-select class-status-select" data-class-id="<?php echo e($class->id); ?>">
