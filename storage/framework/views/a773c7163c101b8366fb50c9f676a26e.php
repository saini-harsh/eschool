        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('student.payments*') ? 'active subdrop' : ''); ?>">
                                <i class="ti ti-credit-card"></i><span>Payment</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('student.payments.index') ? 'active' : ''); ?>" href="<?php echo e(route('student.payments.index')); ?>">
                                        <i class="ti ti-dashboard"></i><span>Payment Dashboard</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('student.payments.pending') ? 'active' : ''); ?>" href="<?php echo e(route('student.payments.pending')); ?>">
                                        <i class="ti ti-clock"></i><span>Pending Payments</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="<?php echo e(request()->routeIs('student.payments.history') ? 'active' : ''); ?>" href="<?php echo e(route('student.payments.history')); ?>">
...
<!-- Sidenav Menu End -->
<?php /**PATH F:\Github\eschool\resources\views////elements/student/left-side-bar.blade.php ENDPATH**/ ?>