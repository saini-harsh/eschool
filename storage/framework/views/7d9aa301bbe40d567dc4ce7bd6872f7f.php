                    ...
                    <div class="dropdown me-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0" id="filter-dropdown">
                            <div class="card mb-0">
                                ...
                                <form action="<?php echo e(route('admin.lesson-plans.index')); ?>" method="GET" id="filter-form">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu w-100">
                                                    <?php if(isset($institutions) && $institutions->count() > 0): ?>
                                                        <?php $__currentLoopData = $institutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="institution_id[]" value="<?php echo e($institution->id); ?>" <?php echo e(in_array($institution->id, (array) request('institution_id', [])) ? 'checked' : ''); ?>>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (clearAllLink) {
            clearAllLink.addEventListener('click', function() {
                window.location.href = '<?php echo e(route("admin.lesson-plans.index")); ?>';
            });
        }
