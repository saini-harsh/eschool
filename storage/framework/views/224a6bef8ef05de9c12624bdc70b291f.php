<?php $__env->startSection('title', 'Admin | Edit Institution'); ?>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <div>
                    ...
                    <form action="<?php echo e(route('admin.institutions.update', $institution->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar avatar-xxl border border-dashed position-relative me-3 flex-shrink-0 p-2">
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(asset($institution->logo)); ?>" class="img-fluid" alt="User Img">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control" 
                                                   value="<?php echo e(old('email', $institution->email)); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" class="form-control" maxlength="20" 
                                                   value="<?php echo e(old('phone', $institution->phone)); ?>" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group w-auto input-group-flat">
                                                <input type="text" name="established_date" class="form-control"
                                                       ...
                                                       value="<?php echo e(old('established_date', \Carbon\Carbon::parse($institution->established_date)->format('d M, Y'))); ?>"
                                                       required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="board" class="form-control" 
                                                   value="<?php echo e(old('board', $institution->board)); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div>
                                            ...
                                            <input type="text" name="website" class="form-control" 
                                                   value="<?php echo e(old('website', $institution->website)); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address" class="form-control" 
                                                   value="<?php echo e(old('address', $institution->address)); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="pincode" maxlength="10" class="form-control" 
                                                   value="<?php echo e(old('pincode', $institution->pincode)); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="state" class="form-control" 
                                                   value="<?php echo e(old('state', $institution->state)); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="district" class="form-control" 
                                                   value="<?php echo e(old('district', $institution->district)); ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <a href="<?php echo e(route('admin.institutions.index')); ?>" class="btn btn-light me-2">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/institutions/edit.blade.php ENDPATH**/ ?>