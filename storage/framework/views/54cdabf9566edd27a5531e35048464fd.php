<?php $__env->startSection('title', 'Tuition Fee Receipt'); ?>
<?php $__env->startSection('content'); ?>

    <div class="content">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h5 class="fw-bold">Tuition Fee Receipt</h5>
            <div>
                                ...
                                <div class="info-section">
                                    ...
                                    <div class="info-list">
                                        <div class="info-item">
                                            ...
                                            <span class="value"><?php echo e($admission->first_name); ?>

                                                <?php echo e($admission->last_name); ?></span>
                                        </div>
                                        <div class="info-item">
                                    ...
                                    <div class="info-list">
                                        <div class="info-item">
                                            ...
                                            <span class="value"><span
                                                    class="fee-type"><?php echo e($payment->feeStructure->name ?? 'Tuition Fee'); ?></span></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Monthly Fee:</span>
                                            <span
                                                class="value">₹<?php echo e(number_format($payment->monthly_fee_amount ?? ($payment->feeStructure->amount ?? 0), 2)); ?></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Number of Months:</span>
                                            <span class="value"><?php echo e($payment->number_of_months ?? 0); ?></span>
                                        </div>
                            ...
                            <div class="content-right">
                                <div class="info-section">
                                    ...
                                    <div class="info-list">
                                        <div class="info-item">
                                            ...
                                            <span
                                                class="value"><?php echo e(\Carbon\Carbon::parse($payment->payment_date)->format('d M, Y')); ?></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Payment Method:</span>
                                            <span class="value"><span
                                                    class="payment-method"><?php echo e(ucfirst($payment->payment_method)); ?></span></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Status:</span>
                                            <span class="value"><span
                                                    class="status-badge completed"><?php echo e(ucfirst($payment->status)); ?></span></span>
                                        </div>
                                ...
                                <div class="amount-section">
                                    <div class="amount-box">
                                        ...
                                        <div class="amount-value">₹<?php echo e(number_format($payment->payment_amount, 2)); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php $__env->startPush('styles'); ?>
        <style>
            /* Same styles as admission-receipt.blade.php */
            .receipt-container {
                background: white;
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\school management software\eschool\resources\views/institution/administration/students/receipts/tuition-receipt.blade.php ENDPATH**/ ?>