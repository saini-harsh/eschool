...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center"><a
                                href="<?php echo e(route('institution.teachers.index')); ?>"><i class="ti ti-home me-1"></i>Home</a>
                        </li>
            ...
            <div>
                <a href="<?php echo e(route('institution.teachers.create')); ?>" class="btn btn-primary"><i
                    ...
                    <?php if(isset($teachers) && !empty($teachers)): ?>
                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="<?php echo e(route('institution.teachers.show', $teacher->id)); ?>"
                                            class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo e(asset($teacher->profile_image)); ?>" alt="img">
                                        </a>
                                        <div class="ms-2">
                                            <h6 class="fs-14 mb-0"><a
                                                    href="<?php echo e(route('institution.teachers.show', $teacher->id)); ?>"><?php echo e($teacher->first_name); ?>

                                                    <?php echo e($teacher->last_name); ?></a></h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="fs-14 mb-0"><a
                                                    href="javascript:void(0);"><?php echo e($teacher->email); ?></a></h6>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge <?php echo e($randomBadgeClass); ?>"><?php echo e($teacher->employee_id ?? 'N/A'); ?></span>
                                    <!-- </a>     -->
                                ...
                                <td>
                                    <div>
                                        <select class="form-select form-select-sm status-select"
                                            ...
                                            <option value="1" <?php echo e($teacher->status == 1 ? 'selected' : ''); ?>>Active
                                            </option>
                                            <option value="0" <?php echo e($teacher->status == 0 ? 'selected' : ''); ?>>Inactive
                                            </option>
                                        </select>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-inline-flex align-items-center">
                                        <a href="<?php echo e(route('institution.login-as.teacher', $teacher->id)); ?>"
                                            class="btn btn-icon btn-sm btn-success border-0" title="Login as Teacher"><i
                                                class="ti ti-login"></i></a>
                                        <a href="<?php echo e(route('institution.teachers.permissions', $teacher->id)); ?>"
                                            class="btn btn-icon btn-sm btn-outline-white border-0" title="Manage Permissions"><i
                                                class="ti ti-lock"></i></a>
                                        <a href="<?php echo e(route('institution.teachers.edit', $teacher->id)); ?>"
                                            class="btn btn-icon btn-sm btn-outline-white border-0" title="Edit"><i
                                                class="ti ti-edit"></i></a>
                                        <a href="javascript:void(0);"
                                            onclick="confirmDelete(`<?php echo e(route('institution.teachers.delete', $teacher->id)); ?>`)"
...
<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/institution/administration/teachers/index.blade.php ENDPATH**/ ?>