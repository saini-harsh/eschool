                        ...
                        <form action="" method="post" id="class-form">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $display): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-4 mb-2">
                                            <div class="form-check">
                                                <input type="checkbox" name="classes[]" value="<?php echo e($value); ?>"
                                                    class="form-check-input class-checkbox" id="class_<?php echo e($value); ?>">
                                                <label class="form-check-label"
                                                    for="class_<?php echo e($value); ?>"><?php echo e($display); ?></label>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('custom/js/institution/schoolclass.js')); ?>"></script>
<?php $__env->stopPush(); ?>
