<?php $__env->startSection('title', 'Student | Events'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span class="text-muted fs-12"><?php echo e(Auth::guard('student')->user()->schoolClass->name ?? 'N/A'); ?> - <?php echo e(Auth::guard('student')->user()->section->name ?? 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // Load events
    function loadEvents() {
        fetch('<?php echo e(route("student.events.api")); ?>')
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/student/academic/events/index.blade.php ENDPATH**/ ?>