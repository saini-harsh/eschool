...
<div class="content">
    ...
    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
        ...
        <div class="d-flex gap-2">
            `<a href="<?php echo e(route('institution.events.index')); ?>" class="btn btn-outline-primary">
...
<script src="<?php echo e(asset('custom/js/institution/calender.js')); ?>"></script>
<?php $__env->stopPush(); ?>



<?php echo $__env->make('layouts.institution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/institution/academic/calendar/index.blade.php ENDPATH**/ ?>