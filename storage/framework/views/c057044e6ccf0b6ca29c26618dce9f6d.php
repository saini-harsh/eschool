    ...
    <?php if(request()->routeIs('admin.dashboard') || request()->routeIs('institution.dashboard') || request()->routeIs('teacher.dashboard') || request()->routeIs('student.dashboard')): ?>
    <!-- Chart JS -->
...
<?php /**PATH D:\school management software\eschool\resources\views/components/dashboard/scripts.blade.php ENDPATH**/ ?>