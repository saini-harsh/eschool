                    ...
                    ?>
                        ...
                        <td>
                            <div class="d-inline-flex align-items-center">
                                ...
                                <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="btn btn-icon btn-sm btn-outline-white border-0"><i
                                        class="ti ti-edit"></i></a>
                                <a href="javascript:void(0);" onclick="confirmDelete(`<?php echo e(route('admin.students.delete', $teacher->id)); ?>`)" class="btn btn-icon btn-sm btn-outline-white border-0"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/teachers/index.blade.php ENDPATH**/ ?>