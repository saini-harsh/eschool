<?php $__env->startSection('title', 'Teacher Dashboard | Scan Attendance'); ?>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="<?php echo e(route('teacher.attendance')); ?>"><i class="ti ti-arrow-left me-1"></i>Attendance
                                Management</a>
                        </li>
            ...
            <div class="card-body">
                ...
                <form id="scan-attendance-form" class="row g-3 align-items-end" style="display:none;">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="scan-class" name="class" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="scan-date" name="date" data-provider="flatpickr"
                            data-date-format="d M, Y" placeholder="dd/mm/yyyy" value="<?php echo e(date('d M, Y')); ?>" required>
                    </div>
                </form>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('custom/js/teacher/scan-attendance.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/teacher/administration/attendance/scan-attendance.blade.php ENDPATH**/ ?>