                        ...
                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="admission_number" class="form-control" value="<?php echo e(old('admission_number', '565')); ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">Roll</label>
                                                    <input type="text" name="roll_number" class="form-control" value="<?php echo e(old('roll_number')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
