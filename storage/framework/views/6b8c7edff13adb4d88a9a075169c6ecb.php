<?php $__env->startSection('title', 'Admin | Non-Working Staff Management'); ?>
...
<div class="content">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                    <li class="breadcrumb-item d-flex align-items-center">
                        <a href="<?php echo e(route('admin.nonworkingstaff.index')); ?>"><i class="ti ti-home me-1"></i>Home</a>
                    </li>
        ...
        <div>
            <a href="<?php echo e(route('admin.nonworkingstaff.create')); ?>" class="btn btn-primary">
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="<?php echo e(route('admin.nonworkingstaff.index')); ?>" class="link-danger text-decoration-underline">Clear
                                        All</a>
                                </div>
                            </div>
                        </div>
                        <form action="<?php echo e(route('admin.nonworkingstaff.index')); ?>" method="GET">
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="form-label">Name</label>
                                        <a href="<?php echo e(route('admin.nonworkingstaff.index')); ?>" class="link-primary mb-1">Reset</a>
                                    </div>
                                    <select name="name" id="filter-name" class="form-select">
                                        <option value="">Select</option>
                                        <?php if(isset($allStaffNames) && $allStaffNames->count()): ?>
                                            <?php $__currentLoopData = $allStaffNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="designation" id="filter-designation" class="form-select">
                                        <option value="">Select</option>
                                        <?php if(isset($designations) && $designations->count()): ?>
                                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($d); ?>" <?php echo e(request('designation') == $d ? 'selected' : ''); ?>><?php echo e($d); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" id="filter-email" class="form-control" placeholder="Email" value="<?php echo e(request('email')); ?>">
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-flex align-items-center">
                                    <a href="<?php echo e(route('admin.nonworkingstaff.permissions', $member->id)); ?>" 
                                        class="btn btn-icon btn-sm btn-outline-white border-0"
                                        title="Manage Permissions">
                                        <i class="ti ti-lock"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.nonworkingstaff.edit', $member->id)); ?>" 
                                        class="btn btn-icon btn-sm btn-outline-white border-0">
                                        <i class="ti ti-edit"></i>
                                    </a>
                                    <a href="javascript:void(0);" 
                                        onclick="confirmDelete(`<?php echo e(route('admin.nonworkingstaff.delete', $member->id)); ?>`)" 
                                        class="btn btn-icon btn-sm btn-outline-white border-0" 
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('custom/js/admin/nonworkingstaff.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\eschool\resources\views/admin/administration/nonworkingstaff/index.blade.php ENDPATH**/ ?>