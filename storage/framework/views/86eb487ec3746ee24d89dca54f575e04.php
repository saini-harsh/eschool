...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!--Header-->
        <?php echo $__env->make('../elements/teacher/header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <!--Content-->
        <!--Left Side Bar-->
        <?php echo $__env->make('../elements/teacher/left-side-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="page-wrapper">
            ...
            <!--Footer-->
            <?php echo $__env->make('../elements/teacher/footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH F:\Github\envision\eschool\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>