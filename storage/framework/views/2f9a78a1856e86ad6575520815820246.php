<?php $__env->startSection('title', 'Admin | Teachers Management'); ?>
...
<?php endif; ?>
     ...
     <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center"><a href="<?php echo e(route('admin.teachers.index')); ?>"><i
            ...
            <div>
                <a href="<?php echo e(route('admin.teachers.create')); ?>" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>New
                Teacher</a>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="dropdown me-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0" id="filter-dropdown">
                        <div class="card mb-0">
                            ...
                            <form action="<?php echo e(route('admin.teachers.index')); ?>" method="GET">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center justify-content-between">
            ...
            <table class="table table-nowrap datatable">
                ...
                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="<?php echo e(route('admin.teachers.show', $teacher->id)); ?>" class="avatar avatar-sm avatar-rounded">
                                <img src="<?php echo e(asset($teacher->profile_image)); ?>"
                                        alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 mb-0"><a href="<?php echo e(route('admin.teachers.show', $teacher->id)); ?>"><?php echo e($teacher->first_name); ?> <?php echo e($teacher->last_name); ?></a></h6>
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    ?>
                        ...
                        <td>
                            <div class="d-inline-flex align-items-center">
                                <a href="<?php echo e(route('admin.login-as.teacher', $teacher->id)); ?>" 
                                   class="btn btn-icon btn-sm btn-success border-0" 
                                   title="Login as Teacher">
                                    <i class="ti ti-login"></i>
                                </a>
                                <a href="<?php echo e(route('admin.teachers.permissions', $teacher->id)); ?>" 
                                   class="btn btn-icon btn-sm btn-outline-white border-0" 
                                   title="Manage Permissions">
                                    <i class="ti ti-lock"></i>
                                </a>
                                <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="btn btn-icon btn-sm btn-outline-white border-0" title="Edit"><i
                                        class="ti ti-edit"></i></a>
                                <a href="javascript:void(0);" onclick="confirmDelete(`<?php echo e(route('admin.teachers.delete', $teacher->id)); ?>`)" class="btn btn-icon btn-sm btn-outline-white border-0"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Github\envision\eschool\resources\views/admin/administration/teachers/index.blade.php ENDPATH**/ ?>