...
function loadClassesByInstitution(institutionId, callback) {
    ...
    if (institutionId) {
        ...
        $.ajax({
            url: '/teacher/students/classes/' + institutionId,
            type: 'GET',
            dataType: 'json',
...
function loadTeachersByInstitution(institutionId, callback) {
    ...
    if (institutionId) {
        ...
        $.ajax({
            url: '/teacher/students/teachers/' + institutionId,
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                teacherSelect.html('<option value="">-- None --</option>');
...
function loadSectionsByClass(classId, callback) {
    ...
    if (classId) {
        ...
        $.ajax({
            url: '/teacher/students/sections/' + classId,
            type: 'GET',
            dataType: 'json',
            success: function(response) {
...
function initStudentStatusUpdates() {
    ...
    $(document).on('change', '.status-select', function() {
        ...
        var url = '/teacher/students/status/' + studentId;
...
function loadClasses(institutionId) {
    if (institutionId) {
        fetch(`/teacher/students/classes/${institutionId}`)
...
function loadTeachers(institutionId) {
    if (institutionId) {
        fetch(`/teacher/students/teachers/${institutionId}`)
            .then(response => response.json())
            .then(data => {
