...
function loadTeachersByInstitution(institutionId) {
    ...
    $.ajax({
        url: `/institution/lesson-plans/teachers/${institutionId}`,
        type: 'GET',
...
function loadClassesByTeacher(institutionId, teacherId) {
    ...
    $.ajax({
        url: `/institution/lesson-plans/classes-by-teacher/${institutionId}/${teacherId}`,
        type: 'GET',
        success: function(response) {
...
function loadClassesByInstitution(institutionId) {
    ...
    $.ajax({
        url: `/institution/lesson-plans/classes/${institutionId}`,
        type: 'GET',
        success: function(response) {
            let options = '<option value="">Select Class</option>';
            response.classes.forEach(function(cls) {
...
function loadSubjectsByInstitutionClass(institutionId, classId) {
    ...
    $.ajax({
        url: `/institution/lesson-plans/subjects/${institutionId}/${classId}`,
        type: 'GET',
        success: function(response) {
...
function submitLessonPlanForm(action) {
    ...
    let url, method;
    if (action === 'create') {
        url = '/institution/lesson-plans';
        method = 'POST';
    } else {
        url = `/institution/lesson-plans/${lessonPlanId}`;
        method = 'POST';
    }
...
function createLessonPlanRow(lessonPlan) {
    ...
    const fileButtons = lessonPlan.lesson_plan_file ? 
        ...
        <a href="/institution/lesson-plans/${lessonPlan.id}/download" class="btn btn-sm btn-outline-success" title="Download PDF">
...
function initRowEventHandlers(row) {
    ...
    row.find('.lesson-plan-status-select').off('change.lessonPlans').on('change.lessonPlans', function(e) {
        ...
        $.ajax({
            url: `/institution/lesson-plans/${lessonPlanId}/status`,
            type: 'POST',
            data: {
    ...
    row.find('.edit-lesson-plan').off('click.lessonPlans').on('click.lessonPlans', function() {
        ...
        $.ajax({
            url: `/institution/lesson-plans/${lessonPlanId}/edit`,
            type: 'GET',
            success: function(response) {
                if (response.success) {
