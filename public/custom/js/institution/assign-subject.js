$(document).ready(function () {
    ...
    if (window.location.pathname.includes('/institution/assign-subject')) {
    ...
    $("#add-assign-subject").on("click", function (e) {
        ...
        // Make AJAX request
        $.ajax({
            url: "/institution/assign-subject/",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    function updateAssignSubjectStatus(assignSubjectId, status) {
        $.ajax({
            url: `/institution/assign-subject/${assignSubjectId}/status`,
            type: "POST",
            data: {
                status: status,
    ...
    $(document).on("click", ".edit-assign-subject", function (e) {
        ...
        $.ajax({
            url: `/institution/assign-subject/${assignSubjectId}/edit`,
            type: "GET",
            success: function (response) {
                if (response.success) {
    ...
    $(document).on("click", "#update-assign-subject", function (e) {
        ...
        $.ajax({
            url: `/institution/assign-subject/${formData.get("id")}`,
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on("click", ".delete-assign-subject", function (e) {
        ...
        $("#deleteForm").attr("action", `/institution/assign-subject/${assignSubjectId}`);
...
function loadClassesByInstitution(institutionId) {
    ...
    $.ajax({
        url: `/institution/assign-subject/classes/${institutionId}`,
        type: 'GET',
        success: function(response) {
...
function loadTeachersByInstitution(institutionId) {
    ...
    $.ajax({
        url: `/institution/assign-subject/teachers/${institutionId}`,
        type: 'GET',
        success: function(response) {
...
function loadSubjectsByInstitutionClass(institutionId, classId) {
    ...
    $.ajax({
        url: `/institution/assign-subject/subjects/${institutionId}/${classId}`,
        type: 'GET',
        success: function(response) {
...
function loadSectionsByClass(classId) {
    ...
    $.ajax({
        url: `/institution/assign-subject/sections/${classId}`,
        type: 'GET',
        success: function(response) {
