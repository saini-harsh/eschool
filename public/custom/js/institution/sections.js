$(document).ready(function () {
    ...
    if ($(".section-status-select").length > 0 || window.location.pathname.includes('/institution/sections')) {
    ...
    $("#add-section").on("click", function (e) {
        ...
        $.ajax({
            url: "/institution/sections/store",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $("#update-section").on("click", function (e) {
        ...
        $.ajax({
            url: `/institution/sections/update/${sectionId}`,
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on("click", ".delete-section", function (e) {
        ...
        $("#deleteForm").attr("action", `/institution/sections/delete/${sectionId}`);
    ...
    $("#deleteForm").on("submit", function (e) {
        ...
        if (!window.location.pathname.includes('/institution/sections')) {
            return;
        }
    ...
    function updateSectionStatus(sectionId, status) {
        $.ajax({
            url: `/institution/sections/${sectionId}/status`,
            type: "POST",
            data: {
                status: status,
