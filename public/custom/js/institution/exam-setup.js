...
$(document).ready(function () {
    $("#institution_id").on("change", function () {
        ...
        $.ajax({
            url: "/institution/exam-management/exam-setup/fetch-data", // Update this route as per your backend
            type: "GET",
    ...
    $("#class_id").on("change", function () {
        ...
        $.ajax({
            url: `/institution/exam-management/exam-setup/fetch-sections/${classId}`,
            type: "GET",
            success: function (response) {
                let sectionOptions = '<option value="">Select Section</option>';
        ...
        $("#schedule-table").on("change", ".subject-select", function () {
            ...
            $(".subject-select").each(function () {
                ...
                $this.find("option").each(function () {
                    ...
                    if (
                        $(this).val() !== currentVal &&
                        selectedSubjects.includes($(this).val())
                    ) {
    ...
    function checkAndFetchSubjects() {
        ...
        if (startDate && endDate && classId) {
            $.ajax({
                url: "/institution/exam-management/exam-setup/fetch-subjects",
                type: "GET",
