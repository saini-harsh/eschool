$(document).ready(function () {
    ...
    $("#update-class_room").off("click.classroom").on("click.classroom", function (e) {
        ...
        $.ajax({
            url: `/institution/classrooms/update/${id}`,
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on("click", ".delete-class-room", function (e) {
        ...
        $("#deleteForm").attr("action", `/institution/classrooms/delete/${id}`);
    ...
    $(document).off("change.classroom", ".class-room-status-select").on("change.classroom", ".class-room-status-select", function () {
        ...
        $.ajax({
            url: `/institution/classrooms/${id}/status`,
            type: "POST",
            data: {
                status: status,
    ...
    function refreshClassRoomList() {
        $.ajax({
            url: "/institution/classrooms/list",
            type: "GET",
            success: function (response) {
                if (response.success) {
