$(document).ready(function() {
    ...
    function loadClassesForReport(institutionId) {
        ...
        $.ajax({
            url: `/admin/routines/classes/${institutionId}`,
            type: 'GET',
            success: function(response) {
    ...
    function loadSectionsByClass(classId) {
        $.ajax({
            url: `/admin/routines/sections/${classId}`,
            type: 'GET',
            success: function(response) {
                if (response.success) {
    ...
    function loadSubjectsByInstitutionClass(institutionId, classId) {
        $.ajax({
            url: `/admin/routines/subjects/${institutionId}/${classId}`,
            type: 'GET',
            success: function(response) {
                if (response.success) {
    ...
    function loadTeachersByInstitution(institutionId) {
        ...
        $.ajax({
            url: `/admin/routines/teachers/${institutionId}`,
            type: 'GET',
            success: function(response) {
