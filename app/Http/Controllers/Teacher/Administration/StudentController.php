...
class StudentController extends Controller
{
    ...
    public function Index(){
        ...
        return view('teacher.administration.students.index',compact('students'));
    }
    public function Create(){
        ...
        return view('teacher.administration.students.create',compact('institution','classes','sections'));
    }
    ...
    public function Store(Request $request)
    {
        ...
        $student->status         = 1;
        $student->admin_id       = $teacher->admin_id;
    ...
    public function Edit(Student $student)
    {
        $teacher = auth('teacher')->user();
        $institutionId = $teacher->institution_id;
        // Ensure the student belongs to the logged-in teacher's institution
        ...
        return view('teacher.administration.students.edit', compact('student', 'institution','classes','sections','teachers'));
    }
