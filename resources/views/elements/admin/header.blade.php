 ...
 <header class="navbar-header">
                <div class="page-container topbar-menu">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-light">
                                <span class="logo-lg"><img src="{{URL::asset('public/admin/img/logo.svg')}}" alt="logo"></span>
                                <span class="logo-sm"><img src="{{URL::asset('public/admin/img/logo-small.svg')}}" alt="small logo"></span>
                            </span>

                            <!-- Logo Dark -->
                            <span class="logo-dark">
                                <span class="logo-lg"><img src="{{URL::asset('public/admin/img/logo-white.svg')}}" alt="dark logo"></span>
                            </span>
                        </a>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="header-item">
                            <div class="dropdown me-2">
                                <button class="topbar-link btn" data-bs-toggle="dropdown" data-bs-offset="0,24" type="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{URL::asset('public/admin/img/flags/us.svg')}}" alt="Language" height="16">
                                </button>
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('public/admin/img/flags/us.svg')}}" alt="" class="me-1" height="16"> <span class="align-middle">English</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('public/admin/img/flags/de.svg')}}" alt="" class="me-1" height="16"> <span class="align-middle">German</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('public/admin/img/flags/fr.svg')}}" alt="" class="me-1" height="16"> <span class="align-middle">French</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="{{URL::asset('public/admin/img/flags/ae.svg')}}" alt="" class="me-1" height="16"> <span class="align-middle">Arabic</span>
                                    </a>
                        ...
                        <div class="header-item">
                            <div class="me-2">
                                <a href="report-calendar.html" class="btn topbar-link"><i class="ti ti-calendar-star fs-16"></i></a>
                            </div>
                        </div>
                                ...
                                <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                                    ...
                                    <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                                        ...
                                        <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
                                            <div class="d-flex">
                                                <div class="me-2 position-relative flex-shrink-0">
                                                    <img src="{{URL::asset('public/admin/img/users/avatar-2.jpg')}}" class="avatar-md rounded-circle" alt="">
                                                </div>
                                        ...
                                        <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
                                            <div class="d-flex">
                                                <div class="me-2 position-relative flex-shrink-0">
                                                    <img src="{{URL::asset('public/admin/img/users/user-02.jpg')}}" class="avatar-md rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
                                            <div class="d-flex">
                                                <div class="me-2 position-relative flex-shrink-0">
                                                    <img src="{{URL::asset('public/admin/img/users/user-04.jpg')}}" class="avatar-md rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
                                            <div class="d-flex">
                                                <div class="me-2 position-relative flex-shrink-0">
                                                    <img src="{{URL::asset('public/admin/img/users/user-24.jpg')}}" class="avatar-md rounded-circle" alt="">
                                                </div>
                                                <div class="flex-grow-1">
