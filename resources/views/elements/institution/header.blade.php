 ...
 <header class="navbar-header">
     <div class="page-container topbar-menu">
         <div class="d-flex align-items-center gap-2">
             ...
             <!-- Logo -->
             <a href="{{ route('institution.dashboard') }}" class="logo">
         ...
         <div class="d-flex align-items-center">
             ...
             <div class="header-item">
                 <div class="me-2">
                     <a href="{{ route('institution.events.index') }}" class="btn topbar-link"><i
             ...
             <div class="header-item">
                 <div>
                     <a href="{{ route('institution.settings.index') }}" class="btn topbar-link"><i class="ti ti-settings fs-16"></i></a>
                 </div>
             </div>
