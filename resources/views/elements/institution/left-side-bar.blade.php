            ...
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ request()->routeIs('institution.institutions*') || request()->routeIs('institution.teachers*') || request()->routeIs('institution.students*') || request()->routeIs('institution.nonworkingstaff*') || request()->routeIs('institution.attendance*') || request()->routeIs('institution.boarding*') ? 'active subdrop' : '' }}">
                            ...
                            <ul>
                                ...
                                @if(PermissionHelper::canShowMenu('boarding'))
                                <li class="">
                                    <a class="{{ request()->routeIs('institution.boarding*') ? 'active' : '' }}"
                                        href="{{ route('institution.boarding.index') }}">
