        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{{ request()->routeIs('institution.fee-structure*') || request()->routeIs('institution.payments*') ? 'active subdrop' : '' }}">
                                <i class="ti ti-credit-card"></i><span>Payment</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li class="">
                                    <a class="{{ request()->routeIs('institution.fee-structure*') ? 'active' : '' }}" href="{{ route('institution.fee-structure.index') }}">
                                        <i class="ti ti-receipt"></i><span>Fee Structure</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a class="{{ request()->routeIs('institution.payments*') ? 'active' : '' }}" href="{{ route('institution.payments.index') }}">
