...
@section('title', 'Admin | Exam Management | Room Details')
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.exam-management.rooms.edit', $classRoom->id) }}" class="btn btn-warning">
                    <i class="ti ti-edit me-1"></i>Edit Room
                </a>
                <a href="{{ route('admin.exam-management.rooms.design-layout', $classRoom->id) }}" class="btn btn-success">
                    <i class="ti ti-layout-grid me-1"></i>Design Layout
                </a>
                <a href="{{ route('admin.exam-management.rooms.index') }}" class="btn btn-secondary">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <a href="{{ route('admin.exam-management.rooms.design-layout', $classRoom->id) }}"
