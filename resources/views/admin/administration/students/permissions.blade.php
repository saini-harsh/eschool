...
@section('title', 'Admin | Manage Permissions - ' . $student->first_name . ' ' . $student->last_name)
@section('content')
@if (session('success'))
...
@endif
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div>
                <a href="{{ route('admin.students.index') }}" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.students.permissions.update', $student->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    <a href="{{ route('admin.students.index') }}" class="btn btn-outline-primary me-2">Cancel</a>
