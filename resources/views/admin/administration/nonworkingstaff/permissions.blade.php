...
@section('title', 'Admin | Manage Permissions - ' . $staff->first_name . ' ' . $staff->last_name)
@section('content')
@if (session('success'))
            ...
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.nonworkingstaff.index') }}">Non-Working Staff</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Permissions</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('admin.nonworkingstaff.index') }}" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.nonworkingstaff.permissions.update', $staff->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    <a href="{{ route('admin.nonworkingstaff.index') }}" class="btn btn-outline-primary me-2">Cancel</a>
