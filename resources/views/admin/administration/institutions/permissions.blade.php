...
@section('title', 'Admin | Manage Permissions - ' . $institution->name)
@section('content')
@if (session('success'))
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="flex-grow-1">
                <h5 class="fw-bold">Manage Permissions - {{ $institution->name }}</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.institutions.index') }}">Institutions</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Permissions</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('admin.institutions.index') }}" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.institutions.permissions.update', $institution->id) }}" method="POST">
                            @csrf
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" 
                                                       ...
                                                       value="{{ $key }}" 
                                                       id="permission_{{ $key }}"
                                                       {{ $institution->permissions === null || in_array($key, $institution->permissions ?? []) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    <a href="{{ route('admin.institutions.index') }}" class="btn btn-outline-primary me-2">Cancel</a>
