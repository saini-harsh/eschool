                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div
                                            class="avatar avatar-xxl border border-dashed position-relative me-3 flex-shrink-0 p-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset($institution->logo) }}" class="img-fluid" alt="User Img">
                                            </div>
                                            <div class="position-absolute top-0 end-0 m-1">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-soft-danger rounded-pill avatar-badge border-0 fs-12"
                                        ...
                                        <div class="d-inline-flex flex-column align-items-start">
                                            <div class="drag-upload-btn btn btn-sm btn-primary position-relative mb-2">
                                                ...
                                                <input type="file" name="profile_image" id="profile_image"
                                                    class="form-control image-sign" accept="image/png, image/jpeg">
                                            </div>
