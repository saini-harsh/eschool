            ...
            <table class="table table-nowrap datatable">
                ...
                @foreach ($teachers as $teacher)
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('admin.teachers.show', $teacher->id) }}" class="avatar avatar-sm avatar-rounded">
                                <img src="{{ asset($teacher->profile_image) }}"
                                        alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 mb-0"><a href="{{ route('admin.teachers.show', $teacher->id) }}">{{ $teacher->first_name }} {{ $teacher->last_name }}</a></h6>
                                </div>
                            </div>
                        </td>
                        <td>
