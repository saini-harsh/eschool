                            ...
                            <div class="col-xl-6 d-flex">
                                <div class="card rounded-0 shadow flex-fill mb-0">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="{{ route('admin.teachers.edit', $teacher->id) }}" class="btn p-1 border-0 btn-outline-white">
                    ...
                    <div class="tab-pane" id="nav_tab_3" role="tabpanel">
                        <div class="card rounded-0 mb-0">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('admin.teachers.edit', $teacher->id) }}" class="btn btn-primary fs-12 py-1">
