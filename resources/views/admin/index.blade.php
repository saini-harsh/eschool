                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <a href="{{ route('admin.attendance.scan-page') }}" class="card border-primary text-decoration-none h-100">
                                    ...
                                    <div class="col-md-4">
                                        <a href="{{ route('admin.attendance.mark-page') }}" class="card border-success text-decoration-none h-100">
                                            <div class="card-body text-center">
                                    ...
                                    <div class="col-md-4">
                                        <a href="{{ route('admin.attendance') }}" class="card border-info text-decoration-none h-100">
                                            <div class="card-body text-center">
