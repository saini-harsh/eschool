...
@section('title', 'Teacher Dashboard | Mark Student Attendance')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="{{ route('teacher.attendance') }}"><i class="ti ti-home me-1"></i>Attendance</a>
                        </li>
...
@push('scripts')
    <script src="{{ asset('custom/js/teacher/mark-attendance.js') }}"></script>
@endpush