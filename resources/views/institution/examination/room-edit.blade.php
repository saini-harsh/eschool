...
@section('title', 'Institution | Exam Management | Edit Room')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editRoomForm" method="POST"
                            action="{{ route('institution.exam-management.rooms.update', $classRoom->id) }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('institution.exam-management.rooms.index') }}"
                        ...
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                window.location.href =
                                    '{{ route('institution.exam-management.rooms.index') }}';
                            }, 1500);
                        } else {
