                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="studentsPerBench" onchange="updateStudentsPerBench()">
                                <option value="1" {{ ($classRoom->students_per_bench ?? 1) == 1 ? 'selected' : '' }}>1
                                    Student</option>
                                <option value="2" {{ ($classRoom->students_per_bench ?? 1) == 2 ? 'selected' : '' }}>2
                                    Students</option>
                                <option value="3" {{ ($classRoom->students_per_bench ?? 1) == 3 ? 'selected' : '' }}>3
                                    Students</option>
                                <option value="4" {{ ($classRoom->students_per_bench ?? 1) == 4 ? 'selected' : '' }}>4
                                    Students</option>
                            </select>
                        </div>
                        <div class="mb-3">
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                layoutData = @json($classRoom->seatmap ?? []);
                studentsPerBench = {{ $classRoom->students_per_bench ?? 1 }};
