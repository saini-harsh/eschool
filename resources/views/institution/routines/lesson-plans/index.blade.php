...
@section('title', 'Institution | Lesson Plans')
@section('content')
                    ...
                    <div class="dropdown me-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 border-0" id="filter-dropdown">
                            <div class="card mb-0">
                                ...
                                <form action="{{ route('institution.lesson-plans.index') }}" method="GET" id="filter-form">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="d-flex align-items-center justify-content-between">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (clearAllLink) {
            clearAllLink.addEventListener('click', function() {
                window.location.href = '{{ route("institution.lesson-plans.index") }}';
            });
        }
...
@push('scripts')
<script src="{{ asset('custom/js/institution/lesson-plans.js') }}"></script>
@endpush
