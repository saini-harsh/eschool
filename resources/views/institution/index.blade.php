                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                                <li class="breadcrumb-item d-flex align-items-center"><a href="{{ route('institution.dashboard') }}">Home</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="index-profile text-center">
                        <img src="{{ $institution->logo ? asset($institution->logo) : '' }}" alt="img" class="avatar avatar-xxl rounded-circle shadow">
                        <div class="text-center mb-0">
                            <h5 class="fw-bold mb-1">Welcome {{ Auth::guard('institution')->user()->name }}</h5>
                            <p class="mb-0">{{ $stats['dateToday'] ?? '' }}</p>
                        </div>
                    </div>
                    <div class="index-profile-links">
                        <a href="{{ route('institution.dashboard') }}" class="dashboard-toggle active">Institution Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="d-flex"><span class="span-divider me-3">{{ number_format($stats['assignments'] ?? 0) }}</span><span>100%</span></div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('{{ route('institution.dashboard.data') }}')
        .then(res => res.json())
        .then(data => {
