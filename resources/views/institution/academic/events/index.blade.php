                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu w-100">
                                                            @php $roleSelections = (array) request('roles', []); @endphp
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="teacher" {{ in_array('teacher', $roleSelections) ? 'checked' : '' }}>
                                                                    Teacher
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="student" {{ in_array('student', $roleSelections) ? 'checked' : '' }}>
                                                                    Student
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="nonworkingstaff" {{ in_array('nonworkingstaff', $roleSelections) ? 'checked' : '' }}>
                                                                    Non-Working Staff
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                                    <input class="form-check-input m-0 me-2" type="checkbox" name="roles[]" value="all" {{ in_array('all', $roleSelections) ? 'checked' : '' }}>
                                                                    All
                                                                </label>
                                                            </li>
                                                        </ul>
...
@push('scripts')
    <script src="{{ asset('custom/js/institution/events.js') }}"></script>
@endpush
