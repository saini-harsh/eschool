...
@section('title', 'Institution | Class Rooms | Edit')
    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="flex-grow-1">
                <h5 class="fw-bold">Edit Class Room</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('institution.classrooms.index') }}">Class Rooms</a>
                        </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title mb-0">Edit Class Room Details</h6>
                    </div>
                    <div class="card-body">
                        <form id="editClassRoomForm" method="POST"
                            action="{{ route('institution.classrooms.update', $classRoom->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('institution.classrooms.index') }}" class="btn btn-secondary">Cancel</a>
            ...
            document.getElementById('editClassRoomForm').addEventListener('submit', function(e) {
                ...
                fetch(this.action, {
                        ...
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                window.location.href =
                                    '{{ route('institution.classrooms.index') }}';
                            }, 1500);
                        } else {
                    ...
                    .catch(error => {
                        ...
                        showToast('error', 'An error occurred while updating the class room');
                    })
                    .finally(() => {
                        // Reset button state
