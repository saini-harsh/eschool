                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="avatar avatar-xxl border border-dashed position-relative me-3 flex-shrink-0 p-2">
                                            <div class="d-felx align-items-center">
                                                <img src="{{ $institution->logo ? asset($institution->logo) : asset('/adminpanel/img/users/avatar-2.jpg') }}" 
                                    ...
                                    <div class="row row-gap-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="{{ $institution->phone ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Website</label>
                                                <input type="url" class="form-control" name="website" value="{{ $institution->website ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Board<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="board" value="{{ $institution->board ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Established Date<span class="text-danger ms-1">*</span></label>
                                                <input type="date" class="form-control" name="established_date" value="{{ $institution->established_date ? $institution->established_date->format('Y-m-d') : '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-gap-3">
                                        <div class="col-lg-12">
                                            <div class="mb-0">
                                                ...
                                                <textarea class="form-control" name="address" rows="3" required>{{ $institution->address ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">State<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="state" value="{{ $institution->state ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">District<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="district" value="{{ $institution->district ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                <label class="form-label">Pin Code<span class="text-danger ms-1">*</span></label>
                                                <input type="text" class="form-control" name="pincode" value="{{ $institution->pincode ?? '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
