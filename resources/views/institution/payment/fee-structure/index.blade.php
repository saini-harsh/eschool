                    ...
                    <div class="card h-100 shadow-sm">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-semibold">{{ $feeStructure->name }}</h6>
                                    <small class="text-muted">{{ $feeStructure->schoolClass->name ?? 'N/A' }}</small>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            @if($feeStructure->description)
                                <p class="text-muted mb-3">{{ Str::limit($feeStructure->description, 80) }}</p>
                            @endif
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold">{{ $feeStructure->schoolClass->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-semibold">{{ $feeStructure->section->name ?? 'All Sections' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="badge bg-{{ $feeStructure->fee_type == 'monthly' ? 'primary' : ($feeStructure->fee_type == 'quarterly' ? 'info' : ($feeStructure->fee_type == 'yearly' ? 'success' : 'warning')) }}">
                                                {{ $feeStructure->fee_type == 'onetime' ? 'One Time' : ucfirst($feeStructure->fee_type) }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-center mb-3">
                                <div class="bg-light rounded p-3">
                                    ...
                                    <h4 class="mb-0 text-primary fw-bold">₹{{ number_format($feeStructure->amount, 2) }}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent">
                            <div class="d-flex gap-2 justify-content-center flex-wrap">
                                <a href="{{ route('institution.payments.record', $feeStructure->id) }}" 
