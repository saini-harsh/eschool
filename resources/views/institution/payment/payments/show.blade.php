            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('institution.payments.index') }}">Payment History</a>
                    </li>
                ...
                <div class="receipt-header">
                    <div class="header-left">
                        <div class="institution-logo">
                            @if($payment->institution->logo)
                                <img src="{{ asset($payment->institution->logo) }}" alt="Logo" class="logo-img">
                            @else
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-list">
                                    <div class="info-item">
                                        ...
                                        <span class="value">{{ $payment->student->first_name }} {{ $payment->student->last_name }}</span>
                                    </div>
                                    <div class="info-item">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="value">{{ $payment->feeStructure->schoolClass->name ?? 'N/A' }}</span>
                                    </div>
                                    <div class="info-item">
                                        <span class="label">Section:</span>
                                        <span class="value">{{ $payment->feeStructure->section->name ?? 'All Sections' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-list">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="value payment-method">{{ ucfirst(str_replace('_', ' ', $payment->payment_method)) }}</span>
                                    </div>
