                                                ...
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            {{ in_array('cash', (array) request('payment_method', [])) ? 'checked' : '' }}>
                                                        Cash
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            {{ in_array('online', (array) request('payment_method', [])) ? 'checked' : '' }}>
                                                        Online
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            {{ in_array('bank_transfer', (array) request('payment_method', [])) ? 'checked' : '' }}>
                                                        Bank Transfer
                                                    </label>
                                                </li>
                                                <li>
                                                    <label class="dropdown-item px-2 d-flex align-items-center rounded-1">
                                                        <input class="form-check-input m-0 me-2" type="checkbox"
                                                            ...
                                                            {{ in_array('cheque', (array) request('payment_method', [])) ? 'checked' : '' }}>
                                                        Cheque
                                                    </label>
                                                </li>
                                            </ul>
                                                    ...
                                                    @foreach ($classes as $class)
                                                        <li>
                                                            <label
                                                                ...
                                                                <input class="form-check-input m-0 me-2" type="checkbox"
                                                                    name="class_section[]" value="{{ $class->id }}_all"
                                                                    {{ in_array($class->id . '_all', (array) request('class_section', [])) ? 'checked' : '' }}>
                                                                ...
                                                                <li>
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input m-0 me-2"
                                                                            ...
                                                                            value="{{ $class->id }}_{{ $section->id }}"
                                                                            {{ in_array($class->id . '_' . $section->id, (array) request('class_section', [])) ? 'checked' : '' }}>
                                ...
                                @foreach ($payments as $payment)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0">{{ $payment->feeStructure->name ?? 'N/A' }}
                                                    </h6>
                                                    <small
                                                        class="text-muted">{{ $payment->feeStructure->schoolClass->name ?? 'N/A' }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <h6 class="fs-14 mb-0 text-success fw-bold">
                                                        ₹{{ number_format($payment->amount, 2) }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="ms-2">
                                                    <span
                                                        class="badge bg-{{ $payment->payment_method == 'cash' ? 'success' : ($payment->payment_method == 'online' ? 'primary' : ($payment->payment_method == 'bank_transfer' ? 'info' : 'secondary')) }}">
