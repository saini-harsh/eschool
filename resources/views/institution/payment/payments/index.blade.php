...
<div class="content">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
        ...
        <div>
            <a href="{{ route('institution.payments.create') }}" class="btn btn-primary me-2">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">{{ $payments->where('payment_status', 'pending')->count() }}</h4>
                        </div>
                        <div class="flex-shrink-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <small class="text-muted">{{ $payment->studentFee->feeStructure->schoolClass->name ?? 'N/A' }}</small>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br><small class="text-muted">{{ $payment->getFormattedPaymentDateWithTime() }}</small>
                                    </td>
                                    <td>
                                        <span class="badge 
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" 
                                                       href="{{ route('institution.payments.show', $payment) }}">
                                                        <i class="ti ti-eye me-2"></i>View Details
                                                    </a>
                                                </li>
                                                @if($payment->payment_status == 'completed')
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('institution.payments.receipt', $payment) }}">
                                                            <i class="ti ti-eye me-2"></i>View Receipt
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('institution.payments.download-receipt', $payment) }}">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        <a href="{{ route('institution.payments.create') }}" class="btn btn-primary">
                            <i class="ti ti-plus me-1"></i>Record Payment
                        </a>
                        <button class="btn btn-outline-success" onclick="generateBills()">
                            <i class="ti ti-refresh me-1"></i>Generate Bills
...
function generateBills() {
    if (confirm('Are you sure you want to generate monthly bills for all students?')) {
        fetch('{{ route("institution.payments.generate-bills") }}', {
            method: 'GET',
            headers: {
