            ...
            <div class="card bg-light">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h6 class="mb-1 fw-semibold">{{ $feeStructure->name }}</h6>
                            <p class="text-muted mb-0">
                                <i class="ti ti-school me-1"></i>{{ $feeStructure->schoolClass->name ?? 'N/A' }}
                                @if($feeStructure->section)
                                    | <i class="ti ti-users me-1"></i>{{ $feeStructure->section->name }}
                                @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="amount" name="amount" 
                                           step="0.01" min="0" value="{{ $feeStructure->amount }}" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr" id="payment_date" name="payment_date" 
                                           value="{{ date('Y-m-d') }}" placeholder="Select payment date" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#paymentForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("institution.payments.store") }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
