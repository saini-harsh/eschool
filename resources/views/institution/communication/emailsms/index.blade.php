...
@section('title', 'Institution | Send Email/SMS')
@section('content')
<style>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="{{ route('institution.dashboard') }}"><i class="ti ti-home me-1"></i>Home</a>
                        </li>
                                    ...
                                    @if (isset($lists) && !empty($lists))
                                        @foreach ($lists as $list)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-{{ $list->send_through === 'email' ? 'primary' : 'success' }}">
                                                        {{ strtoupper($list->send_through) }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <small class="text-muted">
                                                ...
                                                <td>
                                                    <div>
                                                        <select class="form-select message-status-select" data-message-id="{{ $list->id }}">
                                                            <option value="pending" {{ $list->status === 'pending' ? 'selected' : '' }}>Pending</option>
                                                            <option value="sent" {{ $list->status === 'sent' ? 'selected' : '' }}>Sent</option>
...
@push('scripts')
<script src="{{ asset('custom/js/institution/email-sms.js') }}"></script>
@endpush
