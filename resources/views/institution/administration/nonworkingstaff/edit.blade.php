...
@section('title', 'Institution | Edit Non-Working Staff')
@section('content')
@if ($errors->any())
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div>
                ...
                <form action="{{ route('institution.nonworkingstaff.update', $nonworkingstaff->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" name="salary" class="form-control" value="{{ old('salary', $nonworkingstaff->salary) }}" placeholder="e.g., 15000">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="salary_structure_id" class="form-select">
                                            ...
                                            @if(isset($salaryStructures))
                                                @foreach($salaryStructures as $structure)
                                                    <option value="{{ $structure->id }}" {{ $nonworkingstaff->salary_structure_id == $structure->id ? 'selected' : '' }}>{{ $structure->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_name" class="form-control" value="{{ old('bank_name', $nonworkingstaff->bank_name) }}" placeholder="e.g., State Bank of India">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Bank Branch</label>
                                        <input type="text" name="bank_branch" class="form-control" value="{{ old('bank_branch', $nonworkingstaff->bank_branch) }}" placeholder="e.g., Main Branch">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Account Number</label>
                                        <input type="text" name="bank_account_number" class="form-control" value="{{ old('bank_account_number', $nonworkingstaff->bank_account_number) }}" placeholder="Enter account number">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">IFSC Code</label>
                                        <input type="text" name="bank_ifsc_code" class="form-control" value="{{ old('bank_ifsc_code', $nonworkingstaff->bank_ifsc_code) }}" placeholder="e.g., SBIN0001234">
                                    </div>
                                </div>
                            </div>
                        </div>
