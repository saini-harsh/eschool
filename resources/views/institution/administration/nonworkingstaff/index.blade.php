...
@section('title', 'Institution | Non-Working Staff Management')
...
<div class="content">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                    <li class="breadcrumb-item d-flex align-items-center">
                        <a href="{{ route('institution.nonworkingstaff.index') }}"><i class="ti ti-home me-1"></i>Home</a>
                    </li>
        ...
        <div>
            <a href="{{ route('institution.nonworkingstaff.create') }}" class="btn btn-primary">
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('institution.nonworkingstaff.index') }}" class="link-danger text-decoration-underline">Clear
                                        All</a>
                                </div>
                            </div>
                        </div>
                        <form action="{{ route('institution.nonworkingstaff.index') }}" method="GET">
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <label class="form-label">Name</label>
                                        <a href="{{ route('institution.nonworkingstaff.index') }}" class="link-primary mb-1">Reset</a>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-flex align-items-center">
                                    <a href="{{ route('institution.login-as.staff', $member->id) }}" 
                                    ...
                                    <a href="javascript:void(0);" 
                                        onclick="confirmDelete(`{{ route('institution.nonworkingstaff.delete', $member->id) }}`)" 
