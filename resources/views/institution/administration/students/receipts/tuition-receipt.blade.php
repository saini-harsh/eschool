...
@section('title', 'Tuition Fee Receipt')
@section('content')
                                    ...
                                    <div class="info-list">
                                        <div class="info-item">
                                            ...
                                            <span class="value"><span
                                                    class="fee-type">{{ $payment->feeStructure->name ?? 'Tuition Fee' }}</span></span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Monthly Fee:</span>
                                            <span
                                                class="value">₹{{ number_format($payment->monthly_fee_amount ?? ($payment->feeStructure->amount ?? 0), 2) }}</span>
                                        </div>
                                        <div class="info-item">
                                            <span class="label">Number of Months:</span>
                                            <span class="value">{{ $payment->number_of_months ?? 0 }}</span>
                                        </div>
