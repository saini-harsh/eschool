...
@endif
     ...
     <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center"><a href="{{ route('institution.students.index') }}"><i
            ...
            <div>
                <a href="{{ route('institution.students.create') }}" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>New Student</a>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <table class="table table-nowrap datatable">
                ...
                @foreach ($students as $student)
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('institution.students.show', $student->id) }}" class="avatar avatar-sm avatar-rounded">
                                    <img src="{{ asset($student->photo) }}" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 mb-0"><a href="{{ route('institution.students.show', $student->id) }}">{{ $student->first_name }} {{ $student->last_name }}</a></h6>
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="d-inline-flex align-items-center">
                                <a href="{{ route('institution.students.show', $student->id) }}" class="btn btn-icon btn-sm btn-outline-white border-0" title="View Details">
                                    <i class="ti ti-eye"></i>
                                </a>
                                <a href="{{ route('institution.students.edit', $student->id) }}" class="btn btn-icon btn-sm btn-outline-white border-0" title="Edit">
                                    <i class="ti ti-edit"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-white border-0 delete-student" 
                                   data-delete-url="{{ route('institution.students.delete', $student->id) }}"
