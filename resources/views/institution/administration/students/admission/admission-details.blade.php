    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-4">
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('institution.admission.list') }}">Admissions</a>
                        </li>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('institution.admission.list') }}" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-10">
                                <h3 class="fw-bold mb-2">{{ $admission->first_name }} {{ $admission->last_name }}</h3>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Admission Number:</strong>
                                            <span
                                                class="badge bg-primary">{{ $admission->admission_number ?? 'N/A' }}</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->created_at->format('d M, Y h:i A') }}</p>
                            </div>
                            <div class="col-md-4">
                                <label class="text-muted small">PEN Number</label>
                                <p class="mb-0 fw-semibold">{{ $admission->pen_no ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-4">
                                <label class="text-muted small">Institution Code</label>
                                <p class="mb-0 fw-semibold">{{ $admission->institution_code ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->first_name }}</p>
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted small">Last Name</label>
                                <p class="mb-0 fw-semibold">{{ $admission->last_name }}</p>
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted small">Gender</label>
                                <p class="mb-0 fw-semibold">{{ $admission->gender ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->caste_tribe ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted small">Aadhaar Number</label>
                                <p class="mb-0 fw-semibold">{{ $admission->aadhaar_no ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->blood_group ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-4">
                                <label class="text-muted small">Height</label>
                                <p class="mb-0 fw-semibold">{{ $admission->height ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-4">
                                <label class="text-muted small">Weight</label>
                                <p class="mb-0 fw-semibold">{{ $admission->weight ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->email ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted small">Phone</label>
                                <p class="mb-0 fw-semibold">{{ $admission->phone ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-12 mb-3">
                                ...
                                <p class="mb-1"><strong>Address:</strong> {{ $admission->address ?? 'N/A' }}</p>
                                <p class="mb-1"><strong>Pincode:</strong> {{ $admission->pincode ?? 'N/A' }}</p>
                                <p class="mb-0"><strong>District:</strong> {{ $admission->district ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-12">
                                <h6 class="fw-semibold mb-2">Permanent Address</h6>
                                <p class="mb-1"><strong>Address:</strong> {{ $admission->permanent_address ?? 'N/A' }}
                                </p>
                                <p class="mb-1"><strong>Pincode:</strong> {{ $admission->permanent_pincode ?? 'N/A' }}
                                </p>
                                <p class="mb-0"><strong>District:</strong> {{ $admission->permanent_district ?? 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <p class="mb-0 fw-semibold">{{ $admission->father_name ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted small">Father Occupation</label>
                                <p class="mb-0 fw-semibold">{{ $admission->father_occupation ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted small">Father Phone</label>
                                <p class="mb-0 fw-semibold">{{ $admission->father_phone ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted small">Mother Name</label>
                                <p class="mb-0 fw-semibold">{{ $admission->mother_name ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0 fw-semibold">{{ $admission->guardian_name ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small">Relation</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->guardian_relation_text ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small">Guardian Phone</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->guardian_phone ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small">Guardian Address</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->guardian_address ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0 fw-semibold">{{ $admission->previous_school_name ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small">Previous School Class</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->previousSchoolClass->name ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-12">
                                    <label class="text-muted small">Previous School Address</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->previous_school_address ?? 'N/A' }}</p>
                                </div>
                                <div class="col-md-12">
                                    <label class="text-muted small">Previous School Result</label>
                                    <p class="mb-0 fw-semibold">{{ $admission->previous_school_result ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Payment Information -->
                @if ($admissionPayments->count() > 0 || $tuitionFeePayments->count() > 0)
                    <div class="card mb-4">
                        <div class="card-header">
                                ...
                                @if ($tuitionFeePayments->count() > 0)
                                    <div class="col-md-6 mb-4">
                                        ...
                                        @foreach ($tuitionFeePayments as $payment)
                                            <div class="border rounded p-3 mb-3">
                                                <p class="mb-2"><strong>Amount:</strong>
                                                    ₹{{ number_format($payment->payment_amount, 2) }}</p>
                                                <p class="mb-2"><strong>Payment Method:</strong>
                                                    {{ ucfirst($payment->payment_method) }}</p>
                                                <p class="mb-2"><strong>Receipt Number:</strong>
                                                    {{ $payment->receipt_number }}</p>
