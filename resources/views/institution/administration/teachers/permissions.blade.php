...
@section('title', 'Institution | Manage Permissions - ' . $teacher->first_name . ' ' . $teacher->last_name)
@section('content')
@if (session('success'))
            ...
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('institution.teachers.index') }}">Teachers</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Permissions</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('institution.teachers.index') }}" class="btn btn-outline-primary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('institution.teachers.permissions.update', $teacher->id) }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                ...
                                <div>
                                    <a href="{{ route('institution.teachers.index') }}" class="btn btn-outline-primary me-2">Cancel</a>
