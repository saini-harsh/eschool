...
@section('title', 'Institution | Edit Teacher')
@section('content')
...
<div class="content">
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div>
                <h6 class="mb-3 fs-14">
                    <a href="{{ route('institution.teachers.index') }}"><i class="ti ti-arrow-left me-1"></i>Back to Teachers</a>
                </h6>
                <!-- @if ($errors->any())
                ...
                @endif -->
                <form action="{{ route('institution.teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" name="salary" class="form-control" value="{{ old('salary', $teacher->salary) }}" placeholder="e.g., 25000">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="salary_structure_id" class="form-select">
                                            ...
                                            @if(isset($salaryStructures))
                                                @foreach($salaryStructures as $structure)
                                                    <option value="{{ $structure->id }}" {{ $teacher->salary_structure_id == $structure->id ? 'selected' : '' }}>{{ $structure->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_name" class="form-control" value="{{ old('bank_name', $teacher->bank_name) }}" placeholder="e.g., State Bank of India">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Bank Branch</label>
                                        <input type="text" name="bank_branch" class="form-control" value="{{ old('bank_branch', $teacher->bank_branch) }}" placeholder="e.g., Main Branch">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">Account Number</label>
                                        <input type="text" name="bank_account_number" class="form-control" value="{{ old('bank_account_number', $teacher->bank_account_number) }}" placeholder="Enter account number">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label">IFSC Code</label>
                                        <input type="text" name="bank_ifsc_code" class="form-control" value="{{ old('bank_ifsc_code', $teacher->bank_ifsc_code) }}" placeholder="e.g., SBIN0001234">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end mt-3">
                        <a href="{{ route('institution.teachers.index') }}" class="btn btn-light me-2">Cancel</a>
