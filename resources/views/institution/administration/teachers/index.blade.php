...
@endif
     ...
     <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="flex-grow-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center"><a href="{{ route('institution.teachers.index') }}"><i
            ...
            <div>
                <a href="{{ route('institution.teachers.create') }}" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>New
                Teacher</a>
            </div>
        </div>
        <!-- End Page Header -->
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="{{ route('admin.teachers.index') }}" class="link-primary mb-1">Reset</a>
                                        </div>
                                        <select name="name" id="filter-name" class="form-select">
                                            <option value="">Select</option>
                                            @if(isset($allTeacherNames) && $allTeacherNames->count())
                                                @foreach ($allTeacherNames as $n)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="email" id="filter-email" class="form-control" placeholder="Teacher email" value="{{ request('email') }}">
                                    </div>
                                </div>
                    ...
                    @endphp
                        ...
                        <td>
                            <div class="d-inline-flex align-items-center">
                                <a href="{{ route('institution.teachers.edit', $teacher->id) }}" class="btn btn-icon btn-sm btn-outline-white border-0"><i
                                        class="ti ti-edit"></i></a>
                                <a href="javascript:void(0);" onclick="confirmDelete(`{{ route('institution.students.delete', $teacher->id) }}`)" class="btn btn-icon btn-sm btn-outline-white border-0"
