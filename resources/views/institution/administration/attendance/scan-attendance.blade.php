...
@section('title', 'Institution Dashboard | Scan Attendance')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="{{ route('institution.attendance') }}"><i class="ti ti-arrow-left me-1"></i>Attendance
                                Management</a>
                        </li>
...
@push('scripts')
    ...
    <script src="{{ asset('custom/js/institution/scan-attendance.js') }}"></script>
@endpush
