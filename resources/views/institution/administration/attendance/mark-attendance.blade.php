...
@section('title', 'Institution Dashboard | Mark Attendance')
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-divide p-0 mb-0">
                        <li class="breadcrumb-item d-flex align-items-center">
                            <a href="{{ route('institution.attendance') }}"><i class="ti ti-arrow-left me-1"></i>Attendance Management</a>
                        </li>
            ...
            <div class="card-body">
                ...
                <form id="mark-attendance-form" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="date" name="date" data-provider="flatpickr" data-date-format="d M, Y" placeholder="dd/mm/yyyy" value="{{ date('d M, Y') }}" required>
                    </div>
...
@push('scripts')
    <script src="{{ asset('custom/js/institution/mark-attendance.js') }}"></script>
@endpush