    ...
    <div class="content">
        ...
        <form id="paymentForm">
            ...
            <div class="d-flex gap-2 mt-3">
                ...
                <a href="{{ route('institution.salary.payments.index') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
@endsection
...
$(document).ready(function() {
    ...
    $('#payeeId').on('change', function() {
        ...
        $.ajax({
            url: '{{ route("institution.salary.payments.preview") }}',
            type: 'GET',
            data: {
    ...
    $('#paymentForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("institution.salary.payments.store") }}',
            type: 'POST',
            data: $(this).serialize(),
            headers: {
