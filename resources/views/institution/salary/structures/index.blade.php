    ...
    <div class="content">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('institution.salary.structures.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach($structures as $index => $structure)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-success me-1">{{ $structure->earnings->count() }} Earnings</span>
                                            <span class="badge bg-danger">{{ $structure->deductions->count() }} Deductions</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <button type="button" class="btn btn-sm btn-outline-info view-components" 
                                                    ...
                                                    data-structure='@json($structure->components)' 
                                                    data-name="{{ $structure->name }}">
                                                    <i class="ti ti-eye"></i>
                                                </button>
                                                <a href="{{ route('institution.salary.structures.edit', $structure->id) }}" 
                                                    class="btn btn-sm btn-outline-primary">
                                                    <i class="ti ti-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-sm btn-outline-danger delete-btn"
                                                    data-id="{{ $structure->id }}" data-name="{{ $structure->name }}">
