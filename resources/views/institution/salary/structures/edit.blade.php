                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" id="previewBaseSalary" class="form-control" value="25000">
                            </div>
                            <hr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="earningsContainer">
                                @foreach($structure->earnings as $component)
                                    <div class="component-row mb-3 p-3 border rounded" data-type="earning" data-id="{{ $component->id }}">
                                        <div class="row align-items-end">
                                            <div class="col-md-4">
                                                <label class="form-label">Component Name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control component-name" value="{{ $component->name }}" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Amount/Percentage <span class="text-danger">*</span></label>
                                                <input type="number" step="0.01" class="form-control component-amount" value="{{ $component->amount }}" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Type</label>
                                                <select class="form-select component-percentage">
                                                    <option value="0" {{ !$component->is_percentage ? 'selected' : '' }}>Fixed Amount (₹)</option>
                                                    <option value="1" {{ $component->is_percentage ? 'selected' : '' }}>Percentage (%)</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <p class="text-muted small mb-0" id="noEarnings" style="{{ $structure->earnings->count() > 0 ? 'display:none' : '' }}">No earnings added.</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="deductionsContainer">
                                @foreach($structure->deductions as $component)
                                    <div class="component-row mb-3 p-3 border rounded" data-type="deduction" data-id="{{ $component->id }}">
                                        <div class="row align-items-end">
                                            <div class="col-md-4">
                                                <label class="form-label">Component Name <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control component-name" value="{{ $component->name }}" required>
                            ...
                            <p class="text-muted small mb-0" id="noDeductions" style="{{ $structure->deductions->count() > 0 ? 'display:none' : '' }}">No deductions added.</p>
                        </div>
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-check me-1"></i> Update Salary Structure
                        </button>
...
$(document).ready(function() {
    ...
    $('#salaryStructureForm').on('submit', function(e) {
        ...
        $('.component-row').each(function() {
            ...
            // Include ID for existing components
            if ($(this).data('id')) {
                componentData.id = $(this).data('id');
            }
        ...
        $.ajax({
            url: '{{ route("institution.salary.structures.update", $structure->id) }}',
            type: 'PUT',
            ...
            error: function(xhr) {
                ...
                if (errors) {
                    ...
                    toastr.error(xhr.responseJSON?.message || 'Failed to update salary structure');
                }
            }
        });
    });
